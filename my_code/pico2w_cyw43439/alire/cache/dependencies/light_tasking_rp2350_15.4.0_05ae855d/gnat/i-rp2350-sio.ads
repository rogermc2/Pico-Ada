...
package Interfaces.RP2350.SIO is
   pragma Preelaborate;
   ...
   subtype GPIO_HI_IN_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_IN_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_IN_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_IN_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_IN_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_IN_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_IN_Register is record
      ...
      --  unspecified
      Reserved_16_23 : Interfaces.RP2350.Byte;
      --  Read-only. Input value on USB D+ pin
      USB_DP         : GPIO_HI_IN_USB_DP_Field;
      --  Read-only. Input value on USB D- pin
      USB_DM         : GPIO_HI_IN_USB_DM_Field;
      --  Read-only. Input value on QSPI SCK pin
      QSPI_SCK       : GPIO_HI_IN_QSPI_SCK_Field;
      --  Read-only. Input value on QSPI CSn pin
      QSPI_CSN       : GPIO_HI_IN_QSPI_CSN_Field;
   ...
   subtype GPIO_HI_OUT_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OUT_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OUT_Register is record
      ...
      --  unspecified
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Output value for USB D+ pin
      USB_DP         : GPIO_HI_OUT_USB_DP_Field := 16#0#;
      --  Output value for USB D- pin
      USB_DM         : GPIO_HI_OUT_USB_DM_Field := 16#0#;
      --  Output value for QSPI SCK pin
      QSPI_SCK       : GPIO_HI_OUT_QSPI_SCK_Field := 16#0#;
      --  Output value for QSPI CSn pin
      QSPI_CSN       : GPIO_HI_OUT_QSPI_CSN_Field := 16#0#;
   ...
   subtype GPIO_HI_OUT_SET_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OUT_SET_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_SET_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_SET_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_SET_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_SET_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OUT_SET_Register is record
      ...
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Write-only.
      USB_DP         : GPIO_HI_OUT_SET_USB_DP_Field := 16#0#;
      --  Write-only.
      USB_DM         : GPIO_HI_OUT_SET_USB_DM_Field := 16#0#;
      --  Write-only.
      QSPI_SCK       : GPIO_HI_OUT_SET_QSPI_SCK_Field := 16#0#;
      --  Write-only.
      QSPI_CSN       : GPIO_HI_OUT_SET_QSPI_CSN_Field := 16#0#;
      --  Write-only.
   ...
   subtype GPIO_HI_OUT_CLR_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OUT_CLR_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_CLR_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_CLR_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_CLR_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_CLR_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OUT_CLR_Register is record
      ...
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Write-only.
      USB_DP         : GPIO_HI_OUT_CLR_USB_DP_Field := 16#0#;
      --  Write-only.
      USB_DM         : GPIO_HI_OUT_CLR_USB_DM_Field := 16#0#;
      --  Write-only.
      QSPI_SCK       : GPIO_HI_OUT_CLR_QSPI_SCK_Field := 16#0#;
      --  Write-only.
      QSPI_CSN       : GPIO_HI_OUT_CLR_QSPI_CSN_Field := 16#0#;
      --  Write-only.
   ...
   subtype GPIO_HI_OUT_XOR_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OUT_XOR_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_XOR_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_XOR_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_XOR_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OUT_XOR_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OUT_XOR_Register is record
      ...
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Write-only.
      USB_DP         : GPIO_HI_OUT_XOR_USB_DP_Field := 16#0#;
      --  Write-only.
      USB_DM         : GPIO_HI_OUT_XOR_USB_DM_Field := 16#0#;
      --  Write-only.
      QSPI_SCK       : GPIO_HI_OUT_XOR_QSPI_SCK_Field := 16#0#;
      --  Write-only.
      QSPI_CSN       : GPIO_HI_OUT_XOR_QSPI_CSN_Field := 16#0#;
      --  Write-only.
   ...
   subtype GPIO_HI_OE_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OE_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OE_Register is record
      ...
      USB_DP         : GPIO_HI_OE_USB_DP_Field := 16#0#;
      --  Output enable value for USB D- pin
      USB_DM         : GPIO_HI_OE_USB_DM_Field := 16#0#;
      --  Output enable value for QSPI SCK pin
      QSPI_SCK       : GPIO_HI_OE_QSPI_SCK_Field := 16#0#;
      --  Output enable value for QSPI CSn pin
      QSPI_CSN       : GPIO_HI_OE_QSPI_CSN_Field := 16#0#;
   ...
   subtype GPIO_HI_OE_SET_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OE_SET_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_SET_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_SET_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_SET_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_SET_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OE_SET_Register is record
      ...
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Write-only.
      USB_DP         : GPIO_HI_OE_SET_USB_DP_Field := 16#0#;
      --  Write-only.
      USB_DM         : GPIO_HI_OE_SET_USB_DM_Field := 16#0#;
      --  Write-only.
      QSPI_SCK       : GPIO_HI_OE_SET_QSPI_SCK_Field := 16#0#;
      --  Write-only.
      QSPI_CSN       : GPIO_HI_OE_SET_QSPI_CSN_Field := 16#0#;
      --  Write-only.
   ...
   subtype GPIO_HI_OE_CLR_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OE_CLR_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_CLR_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_CLR_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_CLR_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_CLR_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OE_CLR_Register is record
      ...
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Write-only.
      USB_DP         : GPIO_HI_OE_CLR_USB_DP_Field := 16#0#;
      --  Write-only.
      USB_DM         : GPIO_HI_OE_CLR_USB_DM_Field := 16#0#;
      --  Write-only.
      QSPI_SCK       : GPIO_HI_OE_CLR_QSPI_SCK_Field := 16#0#;
      --  Write-only.
      QSPI_CSN       : GPIO_HI_OE_CLR_QSPI_CSN_Field := 16#0#;
      --  Write-only.
   ...
   subtype GPIO_HI_OE_XOR_GPIO_Field is Interfaces.RP2350.UInt16;
   subtype GPIO_HI_OE_XOR_USB_DP_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_XOR_USB_DM_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_XOR_QSPI_SCK_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_XOR_QSPI_CSN_Field is Interfaces.RP2350.Bit;
   subtype GPIO_HI_OE_XOR_QSPI_SD_Field is Interfaces.RP2350.UInt4;
   ...
   type GPIO_HI_OE_XOR_Register is record
      ...
      Reserved_16_23 : Interfaces.RP2350.Byte := 16#0#;
      --  Write-only.
      USB_DP         : GPIO_HI_OE_XOR_USB_DP_Field := 16#0#;
      --  Write-only.
      USB_DM         : GPIO_HI_OE_XOR_USB_DM_Field := 16#0#;
      --  Write-only.
      QSPI_SCK       : GPIO_HI_OE_XOR_QSPI_SCK_Field := 16#0#;
      --  Write-only.
      QSPI_CSN       : GPIO_HI_OE_XOR_QSPI_CSN_Field := 16#0#;
      --  Write-only.
   ...
   subtype FIFO_ST_VLD_Field is Interfaces.RP2350.Bit;
   subtype FIFO_ST_RDY_Field is Interfaces.RP2350.Bit;
   subtype FIFO_ST_WOF_Field is Interfaces.RP2350.Bit;
   subtype FIFO_ST_ROE_Field is Interfaces.RP2350.Bit;
   ...
   subtype INTERP0_CTRL_LANE0_SHIFT_Field is Interfaces.RP2350.UInt5;
   subtype INTERP0_CTRL_LANE0_MASK_LSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP0_CTRL_LANE0_MASK_MSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP0_CTRL_LANE0_SIGNED_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE0_CROSS_INPUT_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE0_CROSS_RESULT_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE0_ADD_RAW_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE0_FORCE_MSB_Field is Interfaces.RP2350.UInt2;
   subtype INTERP0_CTRL_LANE0_BLEND_Field is Interfaces.RP2350.Bit;
   --  INTERP0_CTRL_LANE0_OVERF array element
   subtype INTERP0_CTRL_LANE0_OVERF_Element is Interfaces.RP2350.Bit;
   ...
   subtype INTERP0_CTRL_LANE1_SHIFT_Field is Interfaces.RP2350.UInt5;
   subtype INTERP0_CTRL_LANE1_MASK_LSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP0_CTRL_LANE1_MASK_MSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP0_CTRL_LANE1_SIGNED_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE1_CROSS_INPUT_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE1_CROSS_RESULT_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE1_ADD_RAW_Field is Interfaces.RP2350.Bit;
   subtype INTERP0_CTRL_LANE1_FORCE_MSB_Field is Interfaces.RP2350.UInt2;
   ...
   subtype INTERP1_CTRL_LANE0_SHIFT_Field is Interfaces.RP2350.UInt5;
   subtype INTERP1_CTRL_LANE0_MASK_LSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP1_CTRL_LANE0_MASK_MSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP1_CTRL_LANE0_SIGNED_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE0_CROSS_INPUT_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE0_CROSS_RESULT_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE0_ADD_RAW_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE0_FORCE_MSB_Field is Interfaces.RP2350.UInt2;
   subtype INTERP1_CTRL_LANE0_CLAMP_Field is Interfaces.RP2350.Bit;
   --  INTERP1_CTRL_LANE0_OVERF array element
   subtype INTERP1_CTRL_LANE0_OVERF_Element is Interfaces.RP2350.Bit;
   ...
   type INTERP1_CTRL_LANE0_Register is record
      ...
      --  unspecified
      Reserved_21_21 : Interfaces.RP2350.Bit := 16#0#;
   ...
   subtype INTERP1_CTRL_LANE1_SHIFT_Field is Interfaces.RP2350.UInt5;
   subtype INTERP1_CTRL_LANE1_MASK_LSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP1_CTRL_LANE1_MASK_MSB_Field is Interfaces.RP2350.UInt5;
   subtype INTERP1_CTRL_LANE1_SIGNED_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE1_CROSS_INPUT_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE1_CROSS_RESULT_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE1_ADD_RAW_Field is Interfaces.RP2350.Bit;
   subtype INTERP1_CTRL_LANE1_FORCE_MSB_Field is Interfaces.RP2350.UInt2;
   ...
   subtype DOORBELL_OUT_SET_DOORBELL_OUT_SET_Field is Interfaces.RP2350.Byte;
   ...
   subtype DOORBELL_OUT_CLR_DOORBELL_OUT_CLR_Field is Interfaces.RP2350.Byte;
   ...
   subtype DOORBELL_IN_SET_DOORBELL_IN_SET_Field is Interfaces.RP2350.Byte;
   ...
   subtype DOORBELL_IN_CLR_DOORBELL_IN_CLR_Field is Interfaces.RP2350.Byte;
   ...
   --  PERI_NONSEC_INTERP array element
   subtype PERI_NONSEC_INTERP_Element is Interfaces.RP2350.Bit;

   --  PERI_NONSEC_INTERP array
   type PERI_NONSEC_INTERP_Field_Array is array (0 .. 1)
     of PERI_NONSEC_INTERP_Element
   ...
   subtype PERI_NONSEC_TMDS_Field is Interfaces.RP2350.Bit;
   ...
   type PERI_NONSEC_Register is record
      ...
      --  attach to the Non-secure SIO.
      TMDS          : PERI_NONSEC_TMDS_Field := 16#0#;
      --  unspecified
      Reserved_6_31 : Interfaces.RP2350.UInt26 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype RISCV_SOFTIRQ_CORE0_SET_Field is Interfaces.RP2350.Bit;
   subtype RISCV_SOFTIRQ_CORE1_SET_Field is Interfaces.RP2350.Bit;
   subtype RISCV_SOFTIRQ_CORE0_CLR_Field is Interfaces.RP2350.Bit;
   subtype RISCV_SOFTIRQ_CORE1_CLR_Field is Interfaces.RP2350.Bit;
   ...
   type RISCV_SOFTIRQ_Register is record
      ...
      CORE0_SET      : RISCV_SOFTIRQ_CORE0_SET_Field := 16#0#;
      --  Write 1 to atomically set the core 1 software interrupt flag. Read to
      --  get the status of this flag.
      CORE1_SET      : RISCV_SOFTIRQ_CORE1_SET_Field := 16#0#;
      --  unspecified
      Reserved_2_7   : Interfaces.RP2350.UInt6 := 16#0#;
      --  Write 1 to atomically clear the core 0 software interrupt flag. Read
      --  to get the status of this flag.
      CORE0_CLR      : RISCV_SOFTIRQ_CORE0_CLR_Field := 16#0#;
      --  Write 1 to atomically clear the core 1 software interrupt flag. Read
      --  to get the status of this flag.
      CORE1_CLR      : RISCV_SOFTIRQ_CORE1_CLR_Field := 16#0#;
      --  unspecified
      Reserved_10_31 : Interfaces.RP2350.UInt22 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype MTIME_CTRL_EN_Field is Interfaces.RP2350.Bit;
   subtype MTIME_CTRL_FULLSPEED_Field is Interfaces.RP2350.Bit;
   --  MTIME_CTRL_DBGPAUSE_CORE array element
   subtype MTIME_CTRL_DBGPAUSE_CORE_Element is Interfaces.RP2350.Bit;

   --  MTIME_CTRL_DBGPAUSE_CORE array
   type MTIME_CTRL_DBGPAUSE_CORE_Field_Array is array (0 .. 1)
     of MTIME_CTRL_DBGPAUSE_CORE_Element
     with Component_Size => 1, Size => 2;
   ...
   type MTIME_CTRL_Register is record
      ...
      --  tick input.
      FULLSPEED     : MTIME_CTRL_FULLSPEED_Field := 16#0#;
   ...
   subtype TMDS_CTRL_L0_ROT_Field is Interfaces.RP2350.UInt4;
   subtype TMDS_CTRL_L1_ROT_Field is Interfaces.RP2350.UInt4;
   subtype TMDS_CTRL_L2_ROT_Field is Interfaces.RP2350.UInt4;
   subtype TMDS_CTRL_L0_NBITS_Field is Interfaces.RP2350.UInt3;
   subtype TMDS_CTRL_L1_NBITS_Field is Interfaces.RP2350.UInt3;
   subtype TMDS_CTRL_L2_NBITS_Field is Interfaces.RP2350.UInt3;
   subtype TMDS_CTRL_INTERLEAVE_Field is Interfaces.RP2350.Bit;
   ...
   subtype TMDS_CTRL_PIX2_NOSHIFT_Field is Interfaces.RP2350.Bit;
   subtype TMDS_CTRL_CLEAR_BALANCE_Field is Interfaces.RP2350.Bit;
   ...
   type TMDS_CTRL_Register is record
      ...
      --  unspecified
      Reserved_21_22 : Interfaces.RP2350.UInt2 := 16#0#;
      ...
      INTERLEAVE     : TMDS_CTRL_INTERLEAVE_Field := 16#0#;
      ...
      PIX_SHIFT      : TMDS_CTRL_PIX_SHIFT_Field :=
                        Interfaces.RP2350.SIO.Val_0;
      ...
      --  pixel doubling.
      PIX2_NOSHIFT   : TMDS_CTRL_PIX2_NOSHIFT_Field := 16#0#;
      ...
      CLEAR_BALANCE  : TMDS_CTRL_CLEAR_BALANCE_Field := 16#0#;
      --  unspecified
   ...
   type SIO_Peripheral is record
      ...
      pragma Volatile_Full_Access (GPIO_HI_IN);
      --  GPIO0...31 output value
      GPIO_OUT            : aliased Interfaces.RP2350.UInt32;
      ...
      pragma Volatile_Full_Access (GPIO_HI_OUT);
      --  GPIO0...31 output value set
      GPIO_OUT_SET        : aliased Interfaces.RP2350.UInt32;
      --  Output value set for GPIO32..47, QSPI IOs and USB pins. Perform an
      --  atomic bit-set on GPIO_HI_OUT, i.e. `GPIO_HI_OUT |= wdata`
      GPIO_HI_OUT_SET     : aliased GPIO_HI_OUT_SET_Register;
      pragma Volatile_Full_Access (GPIO_HI_OUT_SET);
      --  GPIO0...31 output value clear
      GPIO_OUT_CLR        : aliased Interfaces.RP2350.UInt32;
      --  Output value clear for GPIO32..47, QSPI IOs and USB pins. Perform an
      --  atomic bit-clear on GPIO_HI_OUT, i.e. `GPIO_HI_OUT &= ~wdata`
      GPIO_HI_OUT_CLR     : aliased GPIO_HI_OUT_CLR_Register;
      pragma Volatile_Full_Access (GPIO_HI_OUT_CLR);
      --  GPIO0...31 output value XOR
      GPIO_OUT_XOR        : aliased Interfaces.RP2350.UInt32;
      --  Output value XOR for GPIO32..47, QSPI IOs and USB pins. Perform an
      --  atomic bitwise XOR on GPIO_HI_OUT, i.e. `GPIO_HI_OUT ^= wdata`
      GPIO_HI_OUT_XOR     : aliased GPIO_HI_OUT_XOR_Register;
      pragma Volatile_Full_Access (GPIO_HI_OUT_XOR);
      --  GPIO0...31 output enable
      GPIO_OE             : aliased Interfaces.RP2350.UInt32;
      ...
      pragma Volatile_Full_Access (GPIO_HI_OE);
      --  GPIO0...31 output enable set
      GPIO_OE_SET         : aliased Interfaces.RP2350.UInt32;
      --  Output enable set for GPIO32...47, QSPI IOs and USB pins. Perform an
      --  atomic bit-set on GPIO_HI_OE, i.e. `GPIO_HI_OE |= wdata`
      GPIO_HI_OE_SET      : aliased GPIO_HI_OE_SET_Register;
      pragma Volatile_Full_Access (GPIO_HI_OE_SET);
      --  GPIO0...31 output enable clear
      GPIO_OE_CLR         : aliased Interfaces.RP2350.UInt32;
      ...
      pragma Volatile_Full_Access (GPIO_HI_OE_CLR);
      --  GPIO0...31 output enable XOR
      GPIO_OE_XOR         : aliased Interfaces.RP2350.UInt32;
      --  Output enable XOR for GPIO32...47, QSPI IOs and USB pins. Perform an
      --  atomic bitwise XOR on GPIO_HI_OE, i.e. `GPIO_HI_OE ^= wdata`
      GPIO_HI_OE_XOR      : aliased GPIO_HI_OE_XOR_Register;
      pragma Volatile_Full_Access (GPIO_HI_OE_XOR);
      ...
      pragma Volatile_Full_Access (FIFO_ST);
      --  Write access to this core's TX FIFO
      FIFO_WR             : aliased Interfaces.RP2350.UInt32;
      --  Read access to this core's RX FIFO
      FIFO_RD             : aliased Interfaces.RP2350.UInt32;
      --  Spinlock state A bitmap containing the state of all 32 spinlocks
      --  (1=locked). Mainly intended for debugging.
      SPINLOCK_ST         : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to accumulator 0
      INTERP0_ACCUM0      : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to accumulator 1
      INTERP0_ACCUM1      : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to BASE0 register.
      INTERP0_BASE0       : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to BASE1 register.
      INTERP0_BASE1       : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to BASE2 register.
      INTERP0_BASE2       : aliased Interfaces.RP2350.UInt32;
      --  Read LANE0 result, and simultaneously write lane results to both
      --  accumulators (POP).
      INTERP0_POP_LANE0   : aliased Interfaces.RP2350.UInt32;
      --  Read LANE1 result, and simultaneously write lane results to both
      --  accumulators (POP).
      INTERP0_POP_LANE1   : aliased Interfaces.RP2350.UInt32;
      --  Read FULL result, and simultaneously write lane results to both
      --  accumulators (POP).
      INTERP0_POP_FULL    : aliased Interfaces.RP2350.UInt32;
      --  Read LANE0 result, without altering any internal state (PEEK).
      INTERP0_PEEK_LANE0  : aliased Interfaces.RP2350.UInt32;
      --  Read LANE1 result, without altering any internal state (PEEK).
      INTERP0_PEEK_LANE1  : aliased Interfaces.RP2350.UInt32;
      --  Read FULL result, without altering any internal state (PEEK).
      INTERP0_PEEK_FULL   : aliased Interfaces.RP2350.UInt32;
      --  Control register for lane 0
      INTERP0_CTRL_LANE0  : aliased INTERP0_CTRL_LANE0_Register;
      pragma Volatile_Full_Access (INTERP0_CTRL_LANE0);
      --  Control register for lane 1
      INTERP0_CTRL_LANE1  : aliased INTERP0_CTRL_LANE1_Register;
      pragma Volatile_Full_Access (INTERP0_CTRL_LANE1);
      ...
      pragma Volatile_Full_Access (INTERP0_ACCUM0_ADD);
      ...
      pragma Volatile_Full_Access (INTERP0_ACCUM1_ADD);
      ...
      --  SIGNED flag is set.
      INTERP0_BASE_1AND0  : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to accumulator 0
      INTERP1_ACCUM0      : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to accumulator 1
      INTERP1_ACCUM1      : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to BASE0 register.
      INTERP1_BASE0       : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to BASE1 register.
      INTERP1_BASE1       : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to BASE2 register.
      INTERP1_BASE2       : aliased Interfaces.RP2350.UInt32;
      --  Read LANE0 result, and simultaneously write lane results to both
      --  accumulators (POP).
      INTERP1_POP_LANE0   : aliased Interfaces.RP2350.UInt32;
      --  Read LANE1 result, and simultaneously write lane results to both
      --  accumulators (POP).
      INTERP1_POP_LANE1   : aliased Interfaces.RP2350.UInt32;
      --  Read FULL result, and simultaneously write lane results to both
      --  accumulators (POP).
      INTERP1_POP_FULL    : aliased Interfaces.RP2350.UInt32;
      --  Read LANE0 result, without altering any internal state (PEEK).
      INTERP1_PEEK_LANE0  : aliased Interfaces.RP2350.UInt32;
      --  Read LANE1 result, without altering any internal state (PEEK).
      INTERP1_PEEK_LANE1  : aliased Interfaces.RP2350.UInt32;
      --  Read FULL result, without altering any internal state (PEEK).
      INTERP1_PEEK_FULL   : aliased Interfaces.RP2350.UInt32;
      --  Control register for lane 0
      INTERP1_CTRL_LANE0  : aliased INTERP1_CTRL_LANE0_Register;
      pragma Volatile_Full_Access (INTERP1_CTRL_LANE0);
      --  Control register for lane 1
      INTERP1_CTRL_LANE1  : aliased INTERP1_CTRL_LANE1_Register;
      pragma Volatile_Full_Access (INTERP1_CTRL_LANE1);
      --  Values written here are atomically added to ACCUM0 Reading yields
      --  lane 0's raw shift and mask value (BASE0 not added).
      INTERP1_ACCUM0_ADD  : aliased INTERP1_ACCUM0_ADD_Register;
      pragma Volatile_Full_Access (INTERP1_ACCUM0_ADD);
      --  Values written here are atomically added to ACCUM1 Reading yields
      --  lane 1's raw shift and mask value (BASE1 not added).
      INTERP1_ACCUM1_ADD  : aliased INTERP1_ACCUM1_ADD_Register;
      pragma Volatile_Full_Access (INTERP1_ACCUM1_ADD);
      --  On write, the lower 16 bits go to BASE0, upper bits to BASE1
      --  simultaneously. Each half is sign-extended to 32 bits if that lane's
      --  SIGNED flag is set.
      INTERP1_BASE_1AND0  : aliased Interfaces.RP2350.UInt32;
      ...
      SPINLOCK0           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK1           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK2           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK3           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK4           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK5           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK6           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK7           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK8           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK9           : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK10          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK11          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK12          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK13          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK14          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK15          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK16          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK17          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK18          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK19          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK20          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK21          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK22          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK23          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK24          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK25          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK26          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK27          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK28          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK29          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK30          : aliased Interfaces.RP2350.UInt32;
      --  Reading from a spinlock address will: - Return 0 if lock is already
      --  locked - Otherwise return nonzero, and simultaneously claim the lock
      --  Writing (any value) releases the lock. If core 0 and core 1 attempt
      --  to claim the same lock simultaneously, core 0 wins. The value
      --  returned on success is 0x1 << lock number.
      SPINLOCK31          : aliased Interfaces.RP2350.UInt32;
      ...
      pragma Volatile_Full_Access (DOORBELL_OUT_SET);
      --  Clear doorbells which have been posted to the opposite core. This
      ...
      pragma Volatile_Full_Access (DOORBELL_OUT_CLR);
      ...
      pragma Volatile_Full_Access (DOORBELL_IN_SET);
      --  Check and acknowledge doorbells posted to this core. This core's
      ...
      pragma Volatile_Full_Access (DOORBELL_IN_CLR);
      ...
      pragma Volatile_Full_Access (PERI_NONSEC);
      ...
      pragma Volatile_Full_Access (RISCV_SOFTIRQ);
      ...
      pragma Volatile_Full_Access (MTIME_CTRL);
      ...
      MTIME               : aliased Interfaces.RP2350.UInt32;
      --  Read/write access to the high half of RISC-V Machine-mode timer. This
      --  register is shared between both cores. If both cores write on the
      --  same cycle, core 1 takes precedence.
      MTIMEH              : aliased Interfaces.RP2350.UInt32;
      ...
      --  64-bit values.
      MTIMECMP            : aliased Interfaces.RP2350.UInt32;
      ...
      MTIMECMPH           : aliased Interfaces.RP2350.UInt32;
      --  Control register for TMDS encoder.
      TMDS_CTRL           : aliased TMDS_CTRL_Register;
      pragma Volatile_Full_Access (TMDS_CTRL);
      --  Write-only access to the TMDS colour data register.
      TMDS_WDATA          : aliased Interfaces.RP2350.UInt32;
      ...
      TMDS_PEEK_SINGLE    : aliased Interfaces.RP2350.UInt32;
      --  Get the encoding of one pixel's worth of colour data, packed into a
      ...
      TMDS_POP_SINGLE     : aliased Interfaces.RP2350.UInt32;
      ...
      TMDS_PEEK_DOUBLE_L0 : aliased Interfaces.RP2350.UInt32;
      --  Get lane 0 of the encoding of two pixels' worth of colour data. Two
      --  10-bit TMDS symbols are packed at the bottom of a 32-bit word. The
      --  POP alias shifts the colour register when read, according to the
      --  values of PIX_SHIFT and PIX2_NOSHIFT.
      TMDS_POP_DOUBLE_L0  : aliased Interfaces.RP2350.UInt32;
      ...
      --  worth of encode are to be read at once, rather than processing the
      --  entire scanline for one lane before moving to the next lane.
      TMDS_PEEK_DOUBLE_L1 : aliased Interfaces.RP2350.UInt32;
      --  Get lane 1 of the encoding of two pixels' worth of colour data. Two
      --  10-bit TMDS symbols are packed at the bottom of a 32-bit word. The
      --  POP alias shifts the colour register when read, according to the
      --  values of PIX_SHIFT and PIX2_NOSHIFT.
      TMDS_POP_DOUBLE_L1  : aliased Interfaces.RP2350.UInt32;
      ...
      --  worth of encode are to be read at once, rather than processing the
      --  entire scanline for one lane before moving to the next lane.
      TMDS_PEEK_DOUBLE_L2 : aliased Interfaces.RP2350.UInt32;
      --  Get lane 2 of the encoding of two pixels' worth of colour data. Two
      --  10-bit TMDS symbols are packed at the bottom of a 32-bit word. The
      --  POP alias shifts the colour register when read, according to the
      --  values of PIX_SHIFT and PIX2_NOSHIFT.
      TMDS_POP_DOUBLE_L2  : aliased Interfaces.RP2350.UInt32;
   end record
     with Volatile;
