...
package Interfaces.RP2350.WATCHDOG is
   pragma Preelaborate;
   ...
   subtype CTRL_TIME_Field is Interfaces.RP2350.UInt24;
   subtype CTRL_PAUSE_JTAG_Field is Interfaces.RP2350.Bit;
   --  CTRL_PAUSE_DBG array element
   subtype CTRL_PAUSE_DBG_Element is Interfaces.RP2350.Bit;
   ...
   subtype CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype CTRL_TRIGGER_Field is Interfaces.RP2350.Bit;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_27_29 : Interfaces.RP2350.UInt3 := 16#0#;
   ...
   subtype LOAD_LOAD_Field is Interfaces.RP2350.UInt24;
   ...
   subtype REASON_TIMER_Field is Interfaces.RP2350.Bit;
   subtype REASON_FORCE_Field is Interfaces.RP2350.Bit;
   ...
   type WATCHDOG_Peripheral is record
      ...
      pragma Volatile_Full_Access (LOAD);
      ...
      pragma Volatile_Full_Access (REASON);
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH0 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH1 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH2 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH3 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH4 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH5 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH6 : aliased Interfaces.RP2350.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH7 : aliased Interfaces.RP2350.UInt32;
   end record
     with Volatile;
...
end Interfaces.RP2350.WATCHDOG;
