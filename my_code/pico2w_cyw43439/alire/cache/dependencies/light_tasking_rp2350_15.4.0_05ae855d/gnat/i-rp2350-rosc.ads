...
package Interfaces.RP2350.ROSC is
   pragma Preelaborate;
   ...
   subtype FREQA_DS0_Field is Interfaces.RP2350.UInt3;
   subtype FREQA_DS0_RANDOM_Field is Interfaces.RP2350.Bit;
   subtype FREQA_DS1_Field is Interfaces.RP2350.UInt3;
   subtype FREQA_DS1_RANDOM_Field is Interfaces.RP2350.Bit;
   subtype FREQA_DS2_Field is Interfaces.RP2350.UInt3;
   subtype FREQA_DS3_Field is Interfaces.RP2350.UInt3;
   ...
   subtype FREQB_DS4_Field is Interfaces.RP2350.UInt3;
   subtype FREQB_DS5_Field is Interfaces.RP2350.UInt3;
   subtype FREQB_DS6_Field is Interfaces.RP2350.UInt3;
   subtype FREQB_DS7_Field is Interfaces.RP2350.UInt3;
   ...
   type FREQB_Register is record
      ...
      --  unspecified
      Reserved_3_3   : Interfaces.RP2350.Bit := 16#0#;
      --  Stage 5 drive strength
      DS5            : FREQB_DS5_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : Interfaces.RP2350.Bit := 16#0#;
   ...
   subtype PHASE_SHIFT_Field is Interfaces.RP2350.UInt2;
   subtype PHASE_FLIP_Field is Interfaces.RP2350.Bit;
   subtype PHASE_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype PHASE_PASSWD_Field is Interfaces.RP2350.Byte;
   ...
   subtype STATUS_DIV_RUNNING_Field is Interfaces.RP2350.Bit;
   ...
   type STATUS_Register is record
      ...
      --  unspecified
      Reserved_17_23 : Interfaces.RP2350.UInt7 := 16#0#;
   ...
   subtype RANDOMBIT_RANDOMBIT_Field is Interfaces.RP2350.Bit;
   ...
   type ROSC_Peripheral is record
      ...
      pragma Volatile_Full_Access (FREQA);
      --  For a detailed description see freqa register
      FREQB     : aliased FREQB_Register;
      pragma Volatile_Full_Access (FREQB);
      --  Loads a value to the LFSR randomiser
      RANDOM    : aliased Interfaces.RP2350.UInt32;
      --  Ring Oscillator pause control
      DORMANT   : aliased Interfaces.RP2350.UInt32;
      --  Controls the output divider
      DIV       : aliased DIV_Register;
      pragma Volatile_Full_Access (DIV);
      --  Controls the phase shifted output
      PHASE     : aliased PHASE_Register;
      pragma Volatile_Full_Access (PHASE);
      --  Ring Oscillator Status
      ...
      pragma Volatile_Full_Access (RANDOMBIT);
      --  A down counter running at the ROSC frequency which counts to zero and
      --  stops. To start the counter write a non-zero value. Can be used for
      --  short software pauses when setting up time sensitive hardware.
