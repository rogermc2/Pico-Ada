...
package Interfaces.RP2350.PLL_SYS is
   pragma Preelaborate;
   ...
   subtype CS_REFDIV_Field is Interfaces.RP2350.UInt6;
   subtype CS_BYPASS_Field is Interfaces.RP2350.Bit;
   subtype CS_LOCK_N_Field is Interfaces.RP2350.Bit;
   subtype CS_LOCK_Field is Interfaces.RP2350.Bit;
   ...
   type CS_Register is record
      ...
      --  unspecified
      Reserved_6_7  : Interfaces.RP2350.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_9_29 : Interfaces.RP2350.UInt21 := 16#0#;
   ...
   subtype PWR_PD_Field is Interfaces.RP2350.Bit;
   subtype PWR_DSMPD_Field is Interfaces.RP2350.Bit;
   subtype PWR_POSTDIVPD_Field is Interfaces.RP2350.Bit;
   subtype PWR_VCOPD_Field is Interfaces.RP2350.Bit;
   ...
   type PWR_Register is record
      ...
      --  unspecified
      Reserved_1_1  : Interfaces.RP2350.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_4_4  : Interfaces.RP2350.Bit := 16#0#;
   ...
   subtype FBDIV_INT_FBDIV_INT_Field is Interfaces.RP2350.UInt12;
   ...
   type FBDIV_INT_Register is record
      ...
      --  unspecified
      Reserved_12_31 : Interfaces.RP2350.UInt20 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype PRIM_POSTDIV2_Field is Interfaces.RP2350.UInt3;
   subtype PRIM_POSTDIV1_Field is Interfaces.RP2350.UInt3;
   ...
   type PRIM_Register is record
      --  unspecified
      Reserved_0_11  : Interfaces.RP2350.UInt12 := 16#0#;
      --  divide by 1-7
      POSTDIV2       : PRIM_POSTDIV2_Field := 16#7#;
      --  unspecified
      Reserved_15_15 : Interfaces.RP2350.Bit := 16#0#;
      --  divide by 1-7
      POSTDIV1       : PRIM_POSTDIV1_Field := 16#7#;
      --  unspecified
      Reserved_19_31 : Interfaces.RP2350.UInt13 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype INTR_LOCK_N_STICKY_Field is Interfaces.RP2350.Bit;

   --  Raw Interrupts
   type INTR_Register is record
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      LOCK_N_STICKY : INTR_LOCK_N_STICKY_Field := 16#0#;
      --  unspecified
   ...
   subtype INTE_LOCK_N_STICKY_Field is Interfaces.RP2350.Bit;

   --  Interrupt Enable
   type INTE_Register is record
      LOCK_N_STICKY : INTE_LOCK_N_STICKY_Field := 16#0#;
      --  unspecified
      Reserved_1_31 : Interfaces.RP2350.UInt31 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype INTF_LOCK_N_STICKY_Field is Interfaces.RP2350.Bit;

   --  Interrupt Force
   type INTF_Register is record
      LOCK_N_STICKY : INTF_LOCK_N_STICKY_Field := 16#0#;
      --  unspecified
      Reserved_1_31 : Interfaces.RP2350.UInt31 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype INTS_LOCK_N_STICKY_Field is Interfaces.RP2350.Bit;

   --  Interrupt status after masking & forcing
   type INTS_Register is record
      --  Read-only.
      LOCK_N_STICKY : INTS_LOCK_N_STICKY_Field;
      --  unspecified
   ...
   type PLL_SYS_Peripheral is record
      ...
      pragma Volatile_Full_Access (PRIM);
      --  Raw Interrupts
