...
package Interfaces.RP2350.TICKS is
   pragma Preelaborate;
   ...
   subtype PROC0_CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype PROC0_CTRL_RUNNING_Field is Interfaces.RP2350.Bit;

   --  Controls the tick generator
   type PROC0_CTRL_Register is record
      --  start / stop tick generation
      ENABLE        : PROC0_CTRL_ENABLE_Field := 16#0#;
      --  Read-only. Is the tick generator running?
      RUNNING       : PROC0_CTRL_RUNNING_Field := 16#0#;
      --  unspecified
   ...
   subtype PROC0_CYCLES_PROC0_CYCLES_Field is Interfaces.RP2350.UInt9;
   ...
   type PROC0_CYCLES_Register is record
      ...
      --  unspecified
      Reserved_9_31 : Interfaces.RP2350.UInt23 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype PROC0_COUNT_PROC0_COUNT_Field is Interfaces.RP2350.UInt9;
   ...
   type PROC0_COUNT_Register is record
      ...
      --  unspecified
      Reserved_9_31 : Interfaces.RP2350.UInt23;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype PROC1_CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype PROC1_CTRL_RUNNING_Field is Interfaces.RP2350.Bit;

   --  Controls the tick generator
   type PROC1_CTRL_Register is record
      --  start / stop tick generation
      ENABLE        : PROC1_CTRL_ENABLE_Field := 16#0#;
      --  Read-only. Is the tick generator running?
      RUNNING       : PROC1_CTRL_RUNNING_Field := 16#0#;
      --  unspecified
      Reserved_2_31 : Interfaces.RP2350.UInt30 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype PROC1_CYCLES_PROC1_CYCLES_Field is Interfaces.RP2350.UInt9;
   ...
   subtype PROC1_COUNT_PROC1_COUNT_Field is Interfaces.RP2350.UInt9;
   ...
   subtype TIMER0_CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype TIMER0_CTRL_RUNNING_Field is Interfaces.RP2350.Bit;

   --  Controls the tick generator
   type TIMER0_CTRL_Register is record
      --  start / stop tick generation
      ENABLE        : TIMER0_CTRL_ENABLE_Field := 16#0#;
      --  Read-only. Is the tick generator running?
      RUNNING       : TIMER0_CTRL_RUNNING_Field := 16#0#;
      --  unspecified
      Reserved_2_31 : Interfaces.RP2350.UInt30 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype TIMER0_CYCLES_TIMER0_CYCLES_Field is Interfaces.RP2350.UInt9;
   ...
   subtype TIMER0_COUNT_TIMER0_COUNT_Field is Interfaces.RP2350.UInt9;
   ...
   subtype TIMER1_CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype TIMER1_CTRL_RUNNING_Field is Interfaces.RP2350.Bit;

   --  Controls the tick generator
   type TIMER1_CTRL_Register is record
      --  start / stop tick generation
      ENABLE        : TIMER1_CTRL_ENABLE_Field := 16#0#;
      --  Read-only. Is the tick generator running?
      RUNNING       : TIMER1_CTRL_RUNNING_Field := 16#0#;
      --  unspecified
      Reserved_2_31 : Interfaces.RP2350.UInt30 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype TIMER1_CYCLES_TIMER1_CYCLES_Field is Interfaces.RP2350.UInt9;
   ...
   subtype TIMER1_COUNT_TIMER1_COUNT_Field is Interfaces.RP2350.UInt9;
   ...
   subtype WATCHDOG_CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype WATCHDOG_CTRL_RUNNING_Field is Interfaces.RP2350.Bit;

   --  Controls the tick generator
   type WATCHDOG_CTRL_Register is record
      --  start / stop tick generation
      ENABLE        : WATCHDOG_CTRL_ENABLE_Field := 16#0#;
      --  Read-only. Is the tick generator running?
      RUNNING       : WATCHDOG_CTRL_RUNNING_Field := 16#0#;
      --  unspecified
      Reserved_2_31 : Interfaces.RP2350.UInt30 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype WATCHDOG_CYCLES_WATCHDOG_CYCLES_Field is Interfaces.RP2350.UInt9;
   ...
   subtype WATCHDOG_COUNT_WATCHDOG_COUNT_Field is Interfaces.RP2350.UInt9;
   ...
   subtype RISCV_CTRL_ENABLE_Field is Interfaces.RP2350.Bit;
   subtype RISCV_CTRL_RUNNING_Field is Interfaces.RP2350.Bit;

   --  Controls the tick generator
   type RISCV_CTRL_Register is record
      --  start / stop tick generation
      ENABLE        : RISCV_CTRL_ENABLE_Field := 16#0#;
      --  Read-only. Is the tick generator running?
      RUNNING       : RISCV_CTRL_RUNNING_Field := 16#0#;
      --  unspecified
      Reserved_2_31 : Interfaces.RP2350.UInt30 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype RISCV_CYCLES_RISCV_CYCLES_Field is Interfaces.RP2350.UInt9;
   ...
   subtype RISCV_COUNT_RISCV_COUNT_Field is Interfaces.RP2350.UInt9;
   ...
   type TICKS_Peripheral is record
      ...
      pragma Volatile_Full_Access (PROC0_CTRL);
      PROC0_CYCLES    : aliased PROC0_CYCLES_Register;
      pragma Volatile_Full_Access (PROC0_CYCLES);
      PROC0_COUNT     : aliased PROC0_COUNT_Register;
      pragma Volatile_Full_Access (PROC0_COUNT);
      --  Controls the tick generator
      PROC1_CTRL      : aliased PROC1_CTRL_Register;
      pragma Volatile_Full_Access (PROC1_CTRL);
      PROC1_CYCLES    : aliased PROC1_CYCLES_Register;
      pragma Volatile_Full_Access (PROC1_CYCLES);
      PROC1_COUNT     : aliased PROC1_COUNT_Register;
      pragma Volatile_Full_Access (PROC1_COUNT);
      --  Controls the tick generator
      TIMER0_CTRL     : aliased TIMER0_CTRL_Register;
      pragma Volatile_Full_Access (TIMER0_CTRL);
      TIMER0_CYCLES   : aliased TIMER0_CYCLES_Register;
      pragma Volatile_Full_Access (TIMER0_CYCLES);
      TIMER0_COUNT    : aliased TIMER0_COUNT_Register;
      pragma Volatile_Full_Access (TIMER0_COUNT);
      --  Controls the tick generator
      TIMER1_CTRL     : aliased TIMER1_CTRL_Register;
      pragma Volatile_Full_Access (TIMER1_CTRL);
      TIMER1_CYCLES   : aliased TIMER1_CYCLES_Register;
      pragma Volatile_Full_Access (TIMER1_CYCLES);
      TIMER1_COUNT    : aliased TIMER1_COUNT_Register;
      pragma Volatile_Full_Access (TIMER1_COUNT);
      --  Controls the tick generator
      WATCHDOG_CTRL   : aliased WATCHDOG_CTRL_Register;
      pragma Volatile_Full_Access (WATCHDOG_CTRL);
      WATCHDOG_CYCLES : aliased WATCHDOG_CYCLES_Register;
      pragma Volatile_Full_Access (WATCHDOG_CYCLES);
      WATCHDOG_COUNT  : aliased WATCHDOG_COUNT_Register;
      pragma Volatile_Full_Access (WATCHDOG_COUNT);
      --  Controls the tick generator
      RISCV_CTRL      : aliased RISCV_CTRL_Register;
      pragma Volatile_Full_Access (RISCV_CTRL);
      RISCV_CYCLES    : aliased RISCV_CYCLES_Register;
      pragma Volatile_Full_Access (RISCV_CYCLES);
      RISCV_COUNT     : aliased RISCV_COUNT_Register;
      pragma Volatile_Full_Access (RISCV_COUNT);
   end record
     with Volatile;
