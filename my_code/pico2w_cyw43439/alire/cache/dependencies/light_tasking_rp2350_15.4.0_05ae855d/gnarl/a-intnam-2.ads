...
package Ada.Interrupts.Names is
   ...
   --  System tick
   TIMER0_IRQ_0_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 0;
   TIMER0_IRQ_1_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 1;
   TIMER0_IRQ_2_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 2;
   TIMER0_IRQ_3_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 3;
   TIMER1_IRQ_0_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 4;
   TIMER1_IRQ_1_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 5;
   TIMER1_IRQ_2_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 6;
   TIMER1_IRQ_3_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 7;
   PWM_IRQ_WRAP_0_Interrupt_CPU_2    : constant Interrupt_ID := 52 + 8;
   PWM_IRQ_WRAP_1_Interrupt_CPU_2    : constant Interrupt_ID := 52 + 9;
   DMA_IRQ_0_Interrupt_CPU_2         : constant Interrupt_ID := 52 + 10;
   DMA_IRQ_1_Interrupt_CPU_2         : constant Interrupt_ID := 52 + 11;
   DMA_IRQ_2_Interrupt_CPU_2         : constant Interrupt_ID := 52 + 12;
   DMA_IRQ_3_Interrupt_CPU_2         : constant Interrupt_ID := 52 + 13;
   USBCTRL_Interrupt_CPU_2           : constant Interrupt_ID := 52 + 14;
   PIO0_IRQ_0_Interrupt_CPU_2        : constant Interrupt_ID := 52 + 15;
   PIO0_IRQ_1_Interrupt_CPU_2        : constant Interrupt_ID := 52 + 16;
   PIO1_IRQ_0_Interrupt_CPU_2        : constant Interrupt_ID := 52 + 17;
   PIO1_IRQ_1_Interrupt_CPU_2        : constant Interrupt_ID := 52 + 18;
   PIO2_IRQ_0_Interrupt_CPU_2        : constant Interrupt_ID := 52 + 19;
   PIO2_IRQ_1_Interrupt_CPU_2        : constant Interrupt_ID := 52 + 20;
   IO_IRQ_BANK0_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 21;
   IO_IRQ_BANK0_NS_Interrupt_CPU_2   : constant Interrupt_ID := 52 + 22;
   IO_IRQ_QSPI_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 23;
   IO_IRQ_QSPI_NS_Interrupt_CPU_2    : constant Interrupt_ID := 52 + 24;
   SIO_IRQ_FIFO_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 25;
   SIO_IRQ_BELL_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 26;
   SIO_IRQ_FIFO_NS_Interrupt_CPU_2   : constant Interrupt_ID := 52 + 27;
   SIO_IRQ_BELL_NS_Interrupt_CPU_2   : constant Interrupt_ID := 52 + 28;
   SIO_IRQ_MTIMECMP_Interrupt_CPU_2  : constant Interrupt_ID := 52 + 29;
   CLOCKS_Interrupt_CPU_2            : constant Interrupt_ID := 52 + 30;
   SPI0_Interrupt_CPU_2              : constant Interrupt_ID := 52 + 31;
   SPI1_Interrupt_CPU_2              : constant Interrupt_ID := 52 + 32;
   UART0_Interrupt_CPU_2             : constant Interrupt_ID := 52 + 33;
   UART1_Interrupt_CPU_2             : constant Interrupt_ID := 52 + 34;
   ADC_IRQ_FIFO_Interrupt_CPU_2      : constant Interrupt_ID := 52 + 35;
   I2C0_Interrupt_CPU_2              : constant Interrupt_ID := 52 + 36;
   I2C1_Interrupt_CPU_2              : constant Interrupt_ID := 52 + 37;
   OTP_Interrupt_CPU_2               : constant Interrupt_ID := 52 + 38;
   TRNG_Interrupt_CPU_2              : constant Interrupt_ID := 52 + 39;
   PLL_SYS_Interrupt_CPU_2           : constant Interrupt_ID := 52 + 42;
   PLL_USB_Interrupt_CPU_2           : constant Interrupt_ID := 52 + 43;
   POWMAN_IRQ_POW_Interrupt_CPU_2    : constant Interrupt_ID := 52 + 44;
   POWMAN_IRQ_TIMER_Interrupt_CPU_2  : constant Interrupt_ID := 52 + 45;
   SPARE_IRQ_0_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 46;
   SPARE_IRQ_1_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 47;
   SPARE_IRQ_2_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 48;
   SPARE_IRQ_3_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 49;
   SPARE_IRQ_4_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 50;
   SPARE_IRQ_5_Interrupt_CPU_2       : constant Interrupt_ID := 52 + 51;
