...
package RP2350.HSTX_FIFO is
   ...
   subtype STAT_LEVEL_Field is RP2350.Byte;
   subtype STAT_FULL_Field is RP2350.Bit;
   subtype STAT_EMPTY_Field is RP2350.Bit;
   subtype STAT_WOF_Field is RP2350.Bit;
   ...
   type STAT_Register is record
      ...
      --  Read-only.
      FULL           : STAT_FULL_Field := 16#0#;
      --  Read-only.
      EMPTY          : STAT_EMPTY_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. FIFO was written when full. Write 1 to clear.
      WOF            : STAT_WOF_Field := 16#0#;
      --  unspecified
