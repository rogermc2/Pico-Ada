...
package RP2350.CORESIGHT_TRACE is
   pragma Preelaborate;
   ...
   subtype CTRL_STATUS_TRACE_CAPTURE_FIFO_FLUSH_Field is RP2350.Bit;
   subtype CTRL_STATUS_TRACE_CAPTURE_FIFO_OVERFLOW_Field is RP2350.Bit;
   ...
   type CTRL_STATUS_Register is record
      ...
      TRACE_CAPTURE_FIFO_FLUSH    : CTRL_STATUS_TRACE_CAPTURE_FIFO_FLUSH_Field :=
                                     16#1#;
      ...
      TRACE_CAPTURE_FIFO_OVERFLOW : CTRL_STATUS_TRACE_CAPTURE_FIFO_OVERFLOW_Field :=
                                     16#0#;
      --  unspecified
   ...
   type CORESIGHT_TRACE_Peripheral is record
      ...
      TRACE_CAPTURE_FIFO : aliased RP2350.UInt32;
   end record
     with Volatile;
