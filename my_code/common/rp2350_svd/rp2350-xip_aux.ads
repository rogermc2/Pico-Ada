...
package RP2350.XIP_AUX is
   ...
   subtype QMI_DIRECT_TX_DATA_Field is RP2350.UInt16;
   ...
   subtype QMI_DIRECT_TX_DWIDTH_Field is RP2350.Bit;
   subtype QMI_DIRECT_TX_OE_Field is RP2350.Bit;
   subtype QMI_DIRECT_TX_NOPUSH_Field is RP2350.Bit;
   ...
   type QMI_DIRECT_TX_Register is record
      ...
      --  mixed freely.
      IWIDTH         : QMI_DIRECT_TX_IWIDTH_Field := RP2350.XIP_AUX.S;
      ...
      DWIDTH         : QMI_DIRECT_TX_DWIDTH_Field := 16#0#;
      ...
      --  of the transfer.
      OE             : QMI_DIRECT_TX_OE_Field := 16#0#;
      ...
      NOPUSH         : QMI_DIRECT_TX_NOPUSH_Field := 16#0#;
      --  unspecified
   ...
   subtype QMI_DIRECT_RX_QMI_DIRECT_RX_Field is RP2350.UInt16;
