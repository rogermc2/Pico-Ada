...
package RP2350.BUSCTRL is
   ...
   subtype BUS_PRIORITY_PROC0_Field is RP2350.Bit;
   subtype BUS_PRIORITY_PROC1_Field is RP2350.Bit;
   subtype BUS_PRIORITY_DMA_R_Field is RP2350.Bit;
   subtype BUS_PRIORITY_DMA_W_Field is RP2350.Bit;
   ...
   subtype BUS_PRIORITY_ACK_BUS_PRIORITY_ACK_Field is RP2350.Bit;
   ...
   subtype PERFCTR_EN_PERFCTR_EN_Field is RP2350.Bit;
   ...
   type PERFCTR_EN_Register is record
      PERFCTR_EN    : PERFCTR_EN_PERFCTR_EN_Field := 16#0#;
      --  unspecified
   ...
   subtype PERFCTR0_PERFCTR0_Field is RP2350.UInt24;
   ...
   type PERFSEL0_Register is record
      ...
      PERFSEL0      : PERFSEL0_PERFSEL0_Field := RP2350.BUSCTRL.sram6_access;
      --  unspecified
   ...
   subtype PERFCTR1_PERFCTR1_Field is RP2350.UInt24;
   ...
   type PERFSEL1_Register is record
      ...
      --  STALL_UPSTREAM, count cycles where any master stalled for any reason,
      --  including contention from other masters.
      PERFSEL1      : PERFSEL1_PERFSEL1_Field := RP2350.BUSCTRL.sram6_access;
      --  unspecified
      Reserved_7_31 : RP2350.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype PERFCTR2_PERFCTR2_Field is RP2350.UInt24;
   ...
   type PERFSEL2_Register is record
      ...
      --  STALL_UPSTREAM, count cycles where any master stalled for any reason,
      --  including contention from other masters.
      PERFSEL2      : PERFSEL2_PERFSEL2_Field := RP2350.BUSCTRL.sram6_access;
      --  unspecified
      Reserved_7_31 : RP2350.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype PERFCTR3_PERFCTR3_Field is RP2350.UInt24;
   ...
   type PERFSEL3_Register is record
      ...
      --  STALL_UPSTREAM, count cycles where any master stalled for any reason,
      --  including contention from other masters.
      PERFSEL3      : PERFSEL3_PERFSEL3_Field := RP2350.BUSCTRL.sram6_access;
      --  unspecified
      Reserved_7_31 : RP2350.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
