...
package RP2350.PIO2 is
   ...
   type SM0_EXECCTRL_Register is record
      ...
      --  behaviour.
      STATUS_N      : SM0_EXECCTRL_STATUS_N_Field := RP2350.PIO2.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM0_EXECCTRL_STATUS_SEL_Field := RP2350.PIO2.TXLEVEL;
   ...
   type SM1_EXECCTRL_Register is record
      ...
      --  than the current FIFO depth are reserved, and have undefined
      --  behaviour.
      STATUS_N      : SM1_EXECCTRL_STATUS_N_Field := RP2350.PIO2.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM1_EXECCTRL_STATUS_SEL_Field := RP2350.PIO2.TXLEVEL;
      --  After reaching wrap_top, execution is wrapped to this address.
   ...
   type SM2_EXECCTRL_Register is record
      ...
      --  than the current FIFO depth are reserved, and have undefined
      --  behaviour.
      STATUS_N      : SM2_EXECCTRL_STATUS_N_Field := RP2350.PIO2.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM2_EXECCTRL_STATUS_SEL_Field := RP2350.PIO2.TXLEVEL;
      --  After reaching wrap_top, execution is wrapped to this address.
   ...
   type SM3_EXECCTRL_Register is record
      ...
      --  than the current FIFO depth are reserved, and have undefined
      --  behaviour.
      STATUS_N      : SM3_EXECCTRL_STATUS_N_Field := RP2350.PIO2.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM3_EXECCTRL_STATUS_SEL_Field := RP2350.PIO2.TXLEVEL;
      --  After reaching wrap_top, execution is wrapped to this address.
