...
package RP2350.EPPB is
   ...
   subtype NMI_MASK1_NMI_MASK1_Field is RP2350.UInt20;
   ...
   subtype SLEEPCTRL_LIGHT_SLEEP_Field is RP2350.Bit;
   subtype SLEEPCTRL_WICENREQ_Field is RP2350.Bit;
   subtype SLEEPCTRL_WICENACK_Field is RP2350.Bit;
   ...
   type SLEEPCTRL_Register is record
      ...
      LIGHT_SLEEP   : SLEEPCTRL_LIGHT_SLEEP_Field := 16#0#;
      ...
      WICENREQ      : SLEEPCTRL_WICENREQ_Field := 16#1#;
      ...
      WICENACK      : SLEEPCTRL_WICENACK_Field := 16#0#;
      --  unspecified
   ...
   type EPPB_Peripheral is record
      ...
      NMI_MASK0 : aliased RP2350.UInt32;
