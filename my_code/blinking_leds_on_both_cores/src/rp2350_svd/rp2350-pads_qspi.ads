...
package RP2350.PADS_QSPI is
   ...
   subtype GPIO_QSPI_SCLK_SLEWFAST_Field is RP2350.Bit;
   subtype GPIO_QSPI_SCLK_SCHMITT_Field is RP2350.Bit;
   subtype GPIO_QSPI_SCLK_PDE_Field is RP2350.Bit;
   subtype GPIO_QSPI_SCLK_PUE_Field is RP2350.Bit;
   ...
   subtype GPIO_QSPI_SCLK_IE_Field is RP2350.Bit;
   subtype GPIO_QSPI_SCLK_OD_Field is RP2350.Bit;
   subtype GPIO_QSPI_SCLK_ISO_Field is RP2350.Bit;
   ...
   type GPIO_QSPI_SCLK_Register is record
      ...
      --  Drive strength.
      DRIVE         : GPIO_QSPI_SCLK_DRIVE_Field := RP2350.PADS_QSPI.Val_4mA;
      --  Input enable
      ...
      --  software.
      ISO           : GPIO_QSPI_SCLK_ISO_Field := 16#1#;
      --  unspecified
   ...
   subtype GPIO_QSPI_SD_SLEWFAST_Field is RP2350.Bit;
   subtype GPIO_QSPI_SD_SCHMITT_Field is RP2350.Bit;
   subtype GPIO_QSPI_SD_PDE_Field is RP2350.Bit;
   subtype GPIO_QSPI_SD_PUE_Field is RP2350.Bit;
   ...
   subtype GPIO_QSPI_SD_IE_Field is RP2350.Bit;
   subtype GPIO_QSPI_SD_OD_Field is RP2350.Bit;
   subtype GPIO_QSPI_SD_ISO_Field is RP2350.Bit;
   ...
   type GPIO_QSPI_SD_Register is record
      ...
      --  Pull down enable
      PDE           : GPIO_QSPI_SD_PDE_Field := 16#1#;
      --  Pull up enable
      PUE           : GPIO_QSPI_SD_PUE_Field := 16#0#;
      --  Drive strength.
      DRIVE         : GPIO_QSPI_SD0_DRIVE_Field := RP2350.PADS_QSPI.Val_4mA;
      --  Input enable
      ...
      --  Pad isolation control. Remove this once the pad is configured by
      --  software.
      ISO           : GPIO_QSPI_SD_ISO_Field := 16#1#;
      --  unspecified
      Reserved_9_31 : RP2350.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype GPIO_QSPI_SS_SLEWFAST_Field is RP2350.Bit;
   subtype GPIO_QSPI_SS_SCHMITT_Field is RP2350.Bit;
   subtype GPIO_QSPI_SS_PDE_Field is RP2350.Bit;
   subtype GPIO_QSPI_SS_PUE_Field is RP2350.Bit;
   ...
   subtype GPIO_QSPI_SS_IE_Field is RP2350.Bit;
   subtype GPIO_QSPI_SS_OD_Field is RP2350.Bit;
   subtype GPIO_QSPI_SS_ISO_Field is RP2350.Bit;
   ...
   type GPIO_QSPI_SS_Register is record
      ...
      --  Drive strength.
      DRIVE         : GPIO_QSPI_SS_DRIVE_Field := RP2350.PADS_QSPI.Val_4mA;
      --  Input enable
      ...
      --  Pad isolation control. Remove this once the pad is configured by
      --  software.
      ISO           : GPIO_QSPI_SS_ISO_Field := 16#1#;
      --  unspecified
      Reserved_9_31 : RP2350.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
