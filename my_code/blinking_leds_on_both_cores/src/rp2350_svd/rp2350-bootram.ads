...
package RP2350.BOOTRAM is
   ...
   subtype BOOTLOCK_STAT_BOOTLOCK_STAT_Field is RP2350.Byte;
   ...
   type BOOTRAM_Peripheral is record
      ...
      WRITE_ONCE0   : aliased RP2350.UInt32;
      --  This registers always ORs writes into its current contents. Once a
      --  bit is set, it can only be cleared by a reset.
      WRITE_ONCE1   : aliased RP2350.UInt32;
      ...
      BOOTLOCK0     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK1     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK2     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK3     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK4     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK5     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK6     : aliased RP2350.UInt32;
      --  Read to claim and check. Write to unclaim. The value returned on
      --  successful claim is 1 << n, and on failed claim is zero.
      BOOTLOCK7     : aliased RP2350.UInt32;
   end record
     with Volatile;
