...
package RP2350.GLITCH_DETECTOR is
   pragma Preelaborate;
...
--  as YES)
   ...
   type ARM_Register is record
      ARM            : ARM_ARM_Field := RP2350.GLITCH_DETECTOR.no;
      --  unspecified
...
--  as NO)
   ...
   type DISARM_Register is record
      ...
      DISARM         : DISARM_DISARM_Field := RP2350.GLITCH_DETECTOR.no;
      --  unspecified
      Reserved_16_31 : RP2350.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SENSITIVITY_DET_Element is RP2350.UInt2;
   ...
   subtype SENSITIVITY_DET0_INV_Field is RP2350.UInt2;
   subtype SENSITIVITY_DET1_INV_Field is RP2350.UInt2;
   subtype SENSITIVITY_DET2_INV_Field is RP2350.UInt2;
   subtype SENSITIVITY_DET3_INV_Field is RP2350.UInt2;
...
--  from this register.
   ...
   subtype LOCK_LOCK_Field is RP2350.Byte;
   ...
   --  TRIG_STATUS_DET array element
   subtype TRIG_STATUS_DET_Element is RP2350.Bit;

   --  TRIG_STATUS_DET array
   type TRIG_STATUS_DET_Field_Array is array (0 .. 3)
     of TRIG_STATUS_DET_Element
   ...
   subtype TRIG_FORCE_TRIG_FORCE_Field is RP2350.UInt4;
