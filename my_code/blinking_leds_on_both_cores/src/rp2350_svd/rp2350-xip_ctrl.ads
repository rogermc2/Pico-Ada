...
package RP2350.XIP_CTRL is
   ...
   subtype CTRL_EN_SECURE_Field is RP2350.Bit;
   subtype CTRL_EN_NONSECURE_Field is RP2350.Bit;
   subtype CTRL_POWER_DOWN_Field is RP2350.Bit;
   subtype CTRL_NO_UNCACHED_SEC_Field is RP2350.Bit;
   subtype CTRL_NO_UNCACHED_NONSEC_Field is RP2350.Bit;
   subtype CTRL_NO_UNTRANSLATED_SEC_Field is RP2350.Bit;
   subtype CTRL_NO_UNTRANSLATED_NONSEC_Field is RP2350.Bit;
   subtype CTRL_MAINT_NONSEC_Field is RP2350.Bit;
   subtype CTRL_SPLIT_WAYS_Field is RP2350.Bit;
   --  CTRL_WRITABLE_M array element
   subtype CTRL_WRITABLE_M_Element is RP2350.Bit;

   --  CTRL_WRITABLE_M array
   type CTRL_WRITABLE_M_Field_Array is array (0 .. 1)
     of CTRL_WRITABLE_M_Element
   ...
   type CTRL_Register is record
      ...
      --  the cache enabled.
      EN_SECURE              : CTRL_EN_SECURE_Field := 16#1#;
      ...
      EN_NONSECURE           : CTRL_EN_NONSECURE_Field := 16#1#;
      --  unspecified
      ...
      MAINT_NONSEC           : CTRL_MAINT_NONSEC_Field := 16#0#;
      ...
      SPLIT_WAYS             : CTRL_SPLIT_WAYS_Field := 16#0#;
   ...
   subtype STAT_FIFO_EMPTY_Field is RP2350.Bit;
   subtype STAT_FIFO_FULL_Field is RP2350.Bit;

   type STAT_Register is record
      --  unspecified
      Reserved_0_0  : RP2350.Bit;
   ...
   subtype STREAM_ADDR_STREAM_ADDR_Field is RP2350.UInt30;
   ...
   subtype STREAM_CTR_STREAM_CTR_Field is RP2350.UInt22;
   ...
   type XIP_CTRL_Peripheral is record
      ...
      --  Cache Hit counter
      CTR_HIT     : aliased RP2350.UInt32;
      --  Cache Access counter
      CTR_ACC     : aliased RP2350.UInt32;
      --  FIFO stream address
      STREAM_ADDR : aliased STREAM_ADDR_Register;
      --  FIFO stream control
      STREAM_CTR  : aliased STREAM_CTR_Register;
      --  FIFO stream data
      STREAM_FIFO : aliased RP2350.UInt32;
   end record
     with Volatile;
