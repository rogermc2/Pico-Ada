...
package RP2350.I2C0 is
   ...
   subtype IC_CON_STOP_DET_IF_MASTER_ACTIVE_Field is RP2350.Bit;
   ...
   type IC_CON_Register is record
      ...
      SPEED                     : IC_CON_SPEED_Field := RP2350.I2C0.FAST;
      --  When acting as a slave, this bit controls whether the DW_apb_i2c
      --  responds to 7- or 10-bit addresses. - 0: 7-bit addressing. The
      --  DW_apb_i2c ignores transactions that involve 10-bit addressing; for
      --  7-bit addressing, only the lower 7 bits of the IC_SAR register are
   ...
   subtype IC_TAR_IC_TAR_Field is RP2350.UInt10;
   ...
   type IC_TAR_Register is record
      ...
      GC_OR_START    : IC_TAR_GC_OR_START_Field := RP2350.I2C0.GENERAL_CALL;
      ...
      SPECIAL        : IC_TAR_SPECIAL_Field := RP2350.I2C0.DISABLED;
      --  unspecified
   ...
   subtype IC_SAR_IC_SAR_Field is RP2350.UInt10;
   ...
   subtype IC_DATA_CMD_DAT_Field is RP2350.Byte;
   ...
   type IC_DATA_CMD_Register is record
      ...
      --  value: 0x0
      CMD             : IC_DATA_CMD_CMD_Field := RP2350.I2C0.WRITE;
      ...
      --  0x0
      STOP            : IC_DATA_CMD_STOP_Field := RP2350.I2C0.DISABLE;
      ...
      RESTART         : IC_DATA_CMD_RESTART_Field := RP2350.I2C0.DISABLE;
   ...
   subtype IC_SS_SCL_HCNT_IC_SS_SCL_HCNT_Field is RP2350.UInt16;
   ...
   subtype IC_SS_SCL_LCNT_IC_SS_SCL_LCNT_Field is RP2350.UInt16;
   ...
   subtype IC_FS_SCL_HCNT_IC_FS_SCL_HCNT_Field is RP2350.UInt16;
   ...
   subtype IC_FS_SCL_LCNT_IC_FS_SCL_LCNT_Field is RP2350.UInt16;
   ...
   type IC_INTR_MASK_Register is record
      ...
      --  Reset value: 0x1
      M_RX_UNDER     : IC_INTR_MASK_M_RX_UNDER_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_RX_OVER interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_RX_OVER      : IC_INTR_MASK_M_RX_OVER_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_RX_FULL interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_RX_FULL      : IC_INTR_MASK_M_RX_FULL_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_TX_OVER interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_TX_OVER      : IC_INTR_MASK_M_TX_OVER_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_TX_EMPTY interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_TX_EMPTY     : IC_INTR_MASK_M_TX_EMPTY_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_RD_REQ interrupt in IC_INTR_STAT register. Reset
      --  value: 0x1
      M_RD_REQ       : IC_INTR_MASK_M_RD_REQ_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_TX_ABRT interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_TX_ABRT      : IC_INTR_MASK_M_TX_ABRT_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_RX_DONE interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_RX_DONE      : IC_INTR_MASK_M_RX_DONE_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_ACTIVITY interrupt in IC_INTR_STAT register.
      --  Reset value: 0x0
      M_ACTIVITY     : IC_INTR_MASK_M_ACTIVITY_Field := RP2350.I2C0.ENABLED;
      --  This bit masks the R_STOP_DET interrupt in IC_INTR_STAT register.
      --  Reset value: 0x0
      M_STOP_DET     : IC_INTR_MASK_M_STOP_DET_Field := RP2350.I2C0.ENABLED;
      --  This bit masks the R_START_DET interrupt in IC_INTR_STAT register.
      --  Reset value: 0x0
      M_START_DET    : IC_INTR_MASK_M_START_DET_Field := RP2350.I2C0.ENABLED;
      --  This bit masks the R_GEN_CALL interrupt in IC_INTR_STAT register.
      --  Reset value: 0x1
      M_GEN_CALL     : IC_INTR_MASK_M_GEN_CALL_Field := RP2350.I2C0.DISABLED;
      --  This bit masks the R_RESTART_DET interrupt in IC_INTR_STAT register.
      --  Reset value: 0x0
   ...
   subtype IC_RX_TL_RX_TL_Field is RP2350.Byte;
   ...
   subtype IC_TX_TL_TX_TL_Field is RP2350.Byte;
   ...
   subtype IC_CLR_INTR_CLR_INTR_Field is RP2350.Bit;
   ...
   subtype IC_CLR_RX_UNDER_CLR_RX_UNDER_Field is RP2350.Bit;
   ...
   subtype IC_CLR_RX_OVER_CLR_RX_OVER_Field is RP2350.Bit;
   ...
   subtype IC_CLR_TX_OVER_CLR_TX_OVER_Field is RP2350.Bit;
   ...
   subtype IC_CLR_RD_REQ_CLR_RD_REQ_Field is RP2350.Bit;
   ...
   subtype IC_CLR_TX_ABRT_CLR_TX_ABRT_Field is RP2350.Bit;
   ...
   subtype IC_CLR_RX_DONE_CLR_RX_DONE_Field is RP2350.Bit;
   ...
   subtype IC_CLR_ACTIVITY_CLR_ACTIVITY_Field is RP2350.Bit;
   ...
   subtype IC_CLR_STOP_DET_CLR_STOP_DET_Field is RP2350.Bit;
   ...
   subtype IC_CLR_START_DET_CLR_START_DET_Field is RP2350.Bit;
   ...
   subtype IC_CLR_GEN_CALL_CLR_GEN_CALL_Field is RP2350.Bit;
   ...
   type IC_ENABLE_Register is record
      ...
      ENABLE        : IC_ENABLE_ENABLE_Field := RP2350.I2C0.DISABLED;
      --  When set, the controller initiates the transfer abort. - 0: ABORT not
      --  initiated or ABORT done - 1: ABORT operation in progress The software
      --  can abort the I2C transfer in master mode by setting this bit. The
      --  software can set this bit only when ENABLE is already set; otherwise,
      ...
      ABORT_k       : IC_ENABLE_ABORT_Field := RP2350.I2C0.DISABLE;
      ...
      TX_CMD_BLOCK  : IC_ENABLE_TX_CMD_BLOCK_Field := RP2350.I2C0.NOT_BLOCKED;
      --  unspecified
   ...
   subtype IC_TXFLR_TXFLR_Field is RP2350.UInt5;
   ...
   subtype IC_RXFLR_RXFLR_Field is RP2350.UInt5;
   ...
   subtype IC_SDA_HOLD_IC_SDA_TX_HOLD_Field is RP2350.UInt16;
   subtype IC_SDA_HOLD_IC_SDA_RX_HOLD_Field is RP2350.Byte;
...
--  present
   ...
   subtype IC_TX_ABRT_SOURCE_TX_FLUSH_CNT_Field is RP2350.UInt9;
   ...
   type IC_DMA_CR_Register is record
      --  Receive DMA Enable. This bit enables/disables the receive FIFO DMA
      --  channel. Reset value: 0x0
      RDMAE         : IC_DMA_CR_RDMAE_Field := RP2350.I2C0.DISABLED;
      --  Transmit DMA Enable. This bit enables/disables the transmit FIFO DMA
      --  channel. Reset value: 0x0
      TDMAE         : IC_DMA_CR_TDMAE_Field := RP2350.I2C0.DISABLED;
      --  unspecified
   ...
   subtype IC_DMA_TDLR_DMATDL_Field is RP2350.UInt4;
   ...
   subtype IC_DMA_RDLR_DMARDL_Field is RP2350.UInt4;
   ...
   subtype IC_SDA_SETUP_SDA_SETUP_Field is RP2350.Byte;
   ...
   subtype IC_FS_SPKLEN_IC_FS_SPKLEN_Field is RP2350.Byte;
   ...
   subtype IC_CLR_RESTART_DET_CLR_RESTART_DET_Field is RP2350.Bit;
   ...
   subtype IC_COMP_PARAM_1_APB_DATA_WIDTH_Field is RP2350.UInt2;
   subtype IC_COMP_PARAM_1_MAX_SPEED_MODE_Field is RP2350.UInt2;
   subtype IC_COMP_PARAM_1_HC_COUNT_VALUES_Field is RP2350.Bit;
   subtype IC_COMP_PARAM_1_INTR_IO_Field is RP2350.Bit;
   subtype IC_COMP_PARAM_1_HAS_DMA_Field is RP2350.Bit;
   subtype IC_COMP_PARAM_1_ADD_ENCODED_PARAMS_Field is RP2350.Bit;
   subtype IC_COMP_PARAM_1_RX_BUFFER_DEPTH_Field is RP2350.Byte;
   subtype IC_COMP_PARAM_1_TX_BUFFER_DEPTH_Field is RP2350.Byte;
   ...
   type I2C0_Peripheral is record
      ...
      IC_COMP_VERSION       : aliased RP2350.UInt32;
      --  I2C Component Type Register
      IC_COMP_TYPE          : aliased RP2350.UInt32;
   end record
     with Volatile;
