...
package RP2350.XOSC is
   ...
   type STATUS_Register is record
      ...
      FREQ_RANGE     : STATUS_FREQ_RANGE_Field := RP2350.XOSC.Val_1_15MHZ;
      --  unspecified
      Reserved_2_11  : RP2350.UInt10 := 16#0#;
      --  Read-only. Oscillator is enabled but not necessarily running and
      --  stable, resets to 0
      ENABLED        : STATUS_ENABLED_Field := 16#0#;
      --  unspecified
      Reserved_13_23 : RP2350.UInt11 := 16#0#;
   ...
   subtype STARTUP_DELAY_Field is RP2350.UInt14;
   subtype STARTUP_X4_Field is RP2350.Bit;
   ...
   type STARTUP_Register is record
      ...
      --  unspecified
      Reserved_14_19 : RP2350.UInt6 := 16#0#;
