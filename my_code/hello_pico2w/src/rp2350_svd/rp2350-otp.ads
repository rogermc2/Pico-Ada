...
package RP2350.OTP is
   ...
   type SW_LOCK_Register is record
      ...
      SEC           : SW_LOCK0_SEC_Field := RP2350.OTP.read_write;
      --  Non-secure lock status. Writes are OR'd with the current value.
      NSEC          : SW_LOCK0_NSEC_Field := RP2350.OTP.read_write;
      --  unspecified
   ...
   subtype SBPI_INSTR_SHORT_WDATA_Field is RP2350.Byte;
   subtype SBPI_INSTR_CMD_Field is RP2350.Byte;
   subtype SBPI_INSTR_TARGET_Field is RP2350.Byte;
   subtype SBPI_INSTR_PAYLOAD_SIZE_M1_Field is RP2350.UInt4;
   subtype SBPI_INSTR_HAS_PAYLOAD_Field is RP2350.Bit;
   subtype SBPI_INSTR_IS_WR_Field is RP2350.Bit;
   subtype SBPI_INSTR_EXEC_Field is RP2350.Bit;
   ...
   type SBPI_INSTR_Register is record
      ...
      HAS_PAYLOAD     : SBPI_INSTR_HAS_PAYLOAD_Field := 16#0#;
      --  Payload type is write
      IS_WR           : SBPI_INSTR_IS_WR_Field := 16#0#;
      --  Write-only. Execute instruction
      EXEC            : SBPI_INSTR_EXEC_Field := 16#0#;
      --  unspecified
   ...
   subtype SBPI_STATUS_RDATA_VLD_Field is RP2350.Bit;
   subtype SBPI_STATUS_INSTR_DONE_Field is RP2350.Bit;
   subtype SBPI_STATUS_INSTR_MISS_Field is RP2350.Bit;
   subtype SBPI_STATUS_FLAG_Field is RP2350.Bit;
   subtype SBPI_STATUS_MISO_Field is RP2350.Byte;

   type SBPI_STATUS_Register is record
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Read command has returned data
      RDATA_VLD      : SBPI_STATUS_RDATA_VLD_Field := 16#0#;
      --  unspecified
      Reserved_1_3   : RP2350.UInt3 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Last instruction done
      INSTR_DONE     : SBPI_STATUS_INSTR_DONE_Field := 16#0#;
      --  unspecified
      Reserved_5_7   : RP2350.UInt3 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Last instruction missed (dropped), as the previous has
      --  not finished running
      INSTR_MISS     : SBPI_STATUS_INSTR_MISS_Field := 16#0#;
      --  unspecified
      Reserved_9_11  : RP2350.UInt3 := 16#0#;
      --  Read-only. SBPI flag
      FLAG           : SBPI_STATUS_FLAG_Field := 16#0#;
      --  unspecified
   ...
   subtype USR_DCTRL_Field is RP2350.Bit;
   subtype USR_PD_Field is RP2350.Bit;
   ...
   subtype DBG_PSM_DONE_Field is RP2350.Bit;
   subtype DBG_BOOT_DONE_Field is RP2350.Bit;
   subtype DBG_ROSC_UP_SEEN_Field is RP2350.Bit;
   subtype DBG_ROSC_UP_Field is RP2350.Bit;
   subtype DBG_PSM_STATE_Field is RP2350.UInt4;
   subtype DBG_CUSTOMER_RMA_FLAG_Field is RP2350.Bit;

   --  Debug for OTP power-on state machine
   type DBG_Register is record
      --  Read-only. PSM done status flag
      PSM_DONE          : DBG_PSM_DONE_Field := 16#0#;
      --  Read-only. PSM boot done status flag
      BOOT_DONE         : DBG_BOOT_DONE_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Ring oscillator was seen up and running
      ROSC_UP_SEEN      : DBG_ROSC_UP_SEEN_Field := 16#0#;
      --  Read-only. Ring oscillator is up and running
      ROSC_UP           : DBG_ROSC_UP_Field := 16#0#;
      ...
      CUSTOMER_RMA_FLAG : DBG_CUSTOMER_RMA_FLAG_Field := 16#0#;
      --  unspecified
   ...
   subtype BIST_CNT_Field is RP2350.UInt13;
   subtype BIST_CNT_MAX_Field is RP2350.UInt12;
   subtype BIST_CNT_ENA_Field is RP2350.Bit;
   subtype BIST_CNT_CLR_Field is RP2350.Bit;
   subtype BIST_CNT_FAIL_Field is RP2350.Bit;
   ...
   subtype CRITICAL_SECURE_BOOT_ENABLE_Field is RP2350.Bit;
   subtype CRITICAL_SECURE_DEBUG_DISABLE_Field is RP2350.Bit;
   subtype CRITICAL_DEBUG_DISABLE_Field is RP2350.Bit;
   subtype CRITICAL_DEFAULT_ARCHSEL_Field is RP2350.Bit;
   subtype CRITICAL_GLITCH_DETECTOR_ENABLE_Field is RP2350.Bit;
   subtype CRITICAL_GLITCH_DETECTOR_SENS_Field is RP2350.UInt2;
   subtype CRITICAL_ARM_DISABLE_Field is RP2350.Bit;
   subtype CRITICAL_RISCV_DISABLE_Field is RP2350.Bit;

   --  Quickly check values of critical flags read during boot up
   type CRITICAL_Register is record
      --  Read-only.
      SECURE_BOOT_ENABLE     : CRITICAL_SECURE_BOOT_ENABLE_Field;
      --  Read-only.
      SECURE_DEBUG_DISABLE   : CRITICAL_SECURE_DEBUG_DISABLE_Field;
      --  Read-only.
      DEBUG_DISABLE          : CRITICAL_DEBUG_DISABLE_Field;
      --  Read-only.
      DEFAULT_ARCHSEL        : CRITICAL_DEFAULT_ARCHSEL_Field;
      --  Read-only.
      GLITCH_DETECTOR_ENABLE : CRITICAL_GLITCH_DETECTOR_ENABLE_Field;
      --  Read-only.
      GLITCH_DETECTOR_SENS   : CRITICAL_GLITCH_DETECTOR_SENS_Field;
      --  unspecified
      Reserved_7_15          : RP2350.UInt9;
      --  Read-only.
      ARM_DISABLE            : CRITICAL_ARM_DISABLE_Field;
      --  Read-only.
      RISCV_DISABLE          : CRITICAL_RISCV_DISABLE_Field;
      --  unspecified
      Reserved_18_31         : RP2350.UInt14;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype KEY_VALID_KEY_VALID_Field is RP2350.Byte;
   ...
   subtype DEBUGEN_PROC0_Field is RP2350.Bit;
   subtype DEBUGEN_PROC0_SECURE_Field is RP2350.Bit;
   subtype DEBUGEN_PROC1_Field is RP2350.Bit;
   subtype DEBUGEN_PROC1_SECURE_Field is RP2350.Bit;
   subtype DEBUGEN_MISC_Field is RP2350.Bit;
   ...
   type DEBUGEN_Register is record
      ...
      PROC0         : DEBUGEN_PROC0_Field := 16#0#;
      ...
      PROC0_SECURE  : DEBUGEN_PROC0_SECURE_Field := 16#0#;
      --  Enable core 1's Mem-AP if it is currently disabled. The Mem-AP is
      --  disabled by default if either of the debug disable critical flags is
      --  set, or if at least one debug key has been enrolled and the least
      --  secure of these enrolled key values has not been provided over SWD.
      PROC1         : DEBUGEN_PROC1_Field := 16#0#;
      ...
      PROC1_SECURE  : DEBUGEN_PROC1_SECURE_Field := 16#0#;
      --  unspecified
   ...
   subtype DEBUGEN_LOCK_PROC0_Field is RP2350.Bit;
   subtype DEBUGEN_LOCK_PROC0_SECURE_Field is RP2350.Bit;
   subtype DEBUGEN_LOCK_PROC1_Field is RP2350.Bit;
   subtype DEBUGEN_LOCK_PROC1_SECURE_Field is RP2350.Bit;
   subtype DEBUGEN_LOCK_MISC_Field is RP2350.Bit;
   ...
   type ARCHSEL_Register is record
      --  Select architecture for core 0.
      CORE0         : ARCHSEL_CORE0_Field := RP2350.OTP.arm;
      --  Select architecture for core 1.
      CORE1         : ARCHSEL_CORE1_Field := RP2350.OTP.arm;
      --  unspecified
   ...
   subtype INTR_SBPI_FLAG_N_Field is RP2350.Bit;
   subtype INTR_SBPI_WR_FAIL_Field is RP2350.Bit;
   subtype INTR_APB_DCTRL_FAIL_Field is RP2350.Bit;
   subtype INTR_APB_RD_SEC_FAIL_Field is RP2350.Bit;
   subtype INTR_APB_RD_NSEC_FAIL_Field is RP2350.Bit;

   --  Raw Interrupts
   type INTR_Register is record
      --  Read-only.
      SBPI_FLAG_N      : INTR_SBPI_FLAG_N_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      SBPI_WR_FAIL     : INTR_SBPI_WR_FAIL_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      APB_DCTRL_FAIL   : INTR_APB_DCTRL_FAIL_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      APB_RD_SEC_FAIL  : INTR_APB_RD_SEC_FAIL_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      APB_RD_NSEC_FAIL : INTR_APB_RD_NSEC_FAIL_Field := 16#0#;
      --  unspecified
      Reserved_5_31    : RP2350.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype INTE_SBPI_FLAG_N_Field is RP2350.Bit;
   subtype INTE_SBPI_WR_FAIL_Field is RP2350.Bit;
   subtype INTE_APB_DCTRL_FAIL_Field is RP2350.Bit;
   subtype INTE_APB_RD_SEC_FAIL_Field is RP2350.Bit;
   subtype INTE_APB_RD_NSEC_FAIL_Field is RP2350.Bit;

   --  Interrupt Enable
   type INTE_Register is record
      SBPI_FLAG_N      : INTE_SBPI_FLAG_N_Field := 16#0#;
      SBPI_WR_FAIL     : INTE_SBPI_WR_FAIL_Field := 16#0#;
      APB_DCTRL_FAIL   : INTE_APB_DCTRL_FAIL_Field := 16#0#;
      APB_RD_SEC_FAIL  : INTE_APB_RD_SEC_FAIL_Field := 16#0#;
      APB_RD_NSEC_FAIL : INTE_APB_RD_NSEC_FAIL_Field := 16#0#;
      --  unspecified
      Reserved_5_31    : RP2350.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype INTF_SBPI_FLAG_N_Field is RP2350.Bit;
   subtype INTF_SBPI_WR_FAIL_Field is RP2350.Bit;
   subtype INTF_APB_DCTRL_FAIL_Field is RP2350.Bit;
   subtype INTF_APB_RD_SEC_FAIL_Field is RP2350.Bit;
   subtype INTF_APB_RD_NSEC_FAIL_Field is RP2350.Bit;

   --  Interrupt Force
   type INTF_Register is record
      SBPI_FLAG_N      : INTF_SBPI_FLAG_N_Field := 16#0#;
      SBPI_WR_FAIL     : INTF_SBPI_WR_FAIL_Field := 16#0#;
      APB_DCTRL_FAIL   : INTF_APB_DCTRL_FAIL_Field := 16#0#;
      APB_RD_SEC_FAIL  : INTF_APB_RD_SEC_FAIL_Field := 16#0#;
      APB_RD_NSEC_FAIL : INTF_APB_RD_NSEC_FAIL_Field := 16#0#;
      --  unspecified
      Reserved_5_31    : RP2350.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype INTS_SBPI_FLAG_N_Field is RP2350.Bit;
   subtype INTS_SBPI_WR_FAIL_Field is RP2350.Bit;
   subtype INTS_APB_DCTRL_FAIL_Field is RP2350.Bit;
   subtype INTS_APB_RD_SEC_FAIL_Field is RP2350.Bit;
   subtype INTS_APB_RD_NSEC_FAIL_Field is RP2350.Bit;

   --  Interrupt status after masking & forcing
   type INTS_Register is record
      --  Read-only.
      SBPI_FLAG_N      : INTS_SBPI_FLAG_N_Field;
      --  Read-only.
      SBPI_WR_FAIL     : INTS_SBPI_WR_FAIL_Field;
      --  Read-only.
      APB_DCTRL_FAIL   : INTS_APB_DCTRL_FAIL_Field;
      --  Read-only.
      APB_RD_SEC_FAIL  : INTS_APB_RD_SEC_FAIL_Field;
      --  Read-only.
      APB_RD_NSEC_FAIL : INTS_APB_RD_NSEC_FAIL_Field;
      --  unspecified
