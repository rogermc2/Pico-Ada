...
package RP2350.QMI is
   ...
   subtype DIRECT_CSR_EN_Field is RP2350.Bit;
   subtype DIRECT_CSR_BUSY_Field is RP2350.Bit;
   subtype DIRECT_CSR_ASSERT_CS0N_Field is RP2350.Bit;
   subtype DIRECT_CSR_ASSERT_CS1N_Field is RP2350.Bit;
   subtype DIRECT_CSR_AUTO_CS0N_Field is RP2350.Bit;
   subtype DIRECT_CSR_AUTO_CS1N_Field is RP2350.Bit;
   subtype DIRECT_CSR_TXFULL_Field is RP2350.Bit;
   subtype DIRECT_CSR_TXEMPTY_Field is RP2350.Bit;
   subtype DIRECT_CSR_TXLEVEL_Field is RP2350.UInt3;
   subtype DIRECT_CSR_RXEMPTY_Field is RP2350.Bit;
   subtype DIRECT_CSR_RXFULL_Field is RP2350.Bit;
   subtype DIRECT_CSR_RXLEVEL_Field is RP2350.UInt3;
   subtype DIRECT_CSR_CLKDIV_Field is RP2350.Byte;
   subtype DIRECT_CSR_RXDELAY_Field is RP2350.UInt2;
   ...
   type DIRECT_CSR_Register is record
      ...
      TXFULL         : DIRECT_CSR_TXFULL_Field := 16#0#;
      ...
      RXEMPTY        : DIRECT_CSR_RXEMPTY_Field := 16#0#;
      ...
      RXFULL         : DIRECT_CSR_RXFULL_Field := 16#0#;
   ...
   subtype DIRECT_TX_DATA_Field is RP2350.UInt16;
   ...
   subtype DIRECT_TX_DWIDTH_Field is RP2350.Bit;
   subtype DIRECT_TX_OE_Field is RP2350.Bit;
   subtype DIRECT_TX_NOPUSH_Field is RP2350.Bit;
   ...
   type DIRECT_TX_Register is record
      ...
      --  mixed freely.
      IWIDTH         : DIRECT_TX_IWIDTH_Field := RP2350.QMI.S;
      ...
      DWIDTH         : DIRECT_TX_DWIDTH_Field := 16#0#;
      ...
      NOPUSH         : DIRECT_TX_NOPUSH_Field := 16#0#;
      --  unspecified
   ...
   subtype DIRECT_RX_DIRECT_RX_Field is RP2350.UInt16;
   ...
   subtype M0_TIMING_CLKDIV_Field is RP2350.Byte;
   subtype M0_TIMING_RXDELAY_Field is RP2350.UInt3;
   subtype M0_TIMING_MIN_DESELECT_Field is RP2350.UInt5;
   subtype M0_TIMING_MAX_SELECT_Field is RP2350.UInt6;
   subtype M0_TIMING_SELECT_HOLD_Field is RP2350.UInt2;
   subtype M0_TIMING_SELECT_SETUP_Field is RP2350.Bit;
   ...
   subtype M0_TIMING_COOLDOWN_Field is RP2350.UInt2;
   ...
   type M0_TIMING_Register is record
      ...
      SELECT_SETUP   : M0_TIMING_SELECT_SETUP_Field := 16#0#;
      --  unspecified
      Reserved_26_27 : RP2350.UInt2 := 16#0#;
      ...
      PAGEBREAK      : M0_TIMING_PAGEBREAK_Field := RP2350.QMI.NONE;
   ...
   subtype M0_RFMT_DTR_Field is RP2350.Bit;
   ...
   type M0_RFMT_Register is record
      --  The transfer width used for the command prefix, if any
      PREFIX_WIDTH   : M0_RFMT_PREFIX_WIDTH_Field := RP2350.QMI.S;
      --  The transfer width used for the address. The address phase always
      --  transfers 24 bits in total.
      ADDR_WIDTH     : M0_RFMT_ADDR_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the post-address command suffix, if any
      SUFFIX_WIDTH   : M0_RFMT_SUFFIX_WIDTH_Field := RP2350.QMI.S;
      ...
      --  the dummy phase.
      DUMMY_WIDTH    : M0_RFMT_DUMMY_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the data transfer
      DATA_WIDTH     : M0_RFMT_DATA_WIDTH_Field := RP2350.QMI.S;
      --  unspecified
      Reserved_10_11 : RP2350.UInt2 := 16#0#;
      --  Length of command prefix, in units of 8 bits. (i.e. 2 cycles for quad
      --  width, 4 for dual, 8 for single)
      PREFIX_LEN     : M0_RFMT_PREFIX_LEN_Field := RP2350.QMI.Val_8;
      --  unspecified
      Reserved_13_13 : RP2350.Bit := 16#0#;
      ...
      SUFFIX_LEN     : M0_RFMT_SUFFIX_LEN_Field := RP2350.QMI.NONE;
      ...
      DUMMY_LEN      : M0_RFMT_DUMMY_LEN_Field := RP2350.QMI.NONE;
      --  unspecified
      Reserved_19_27 : RP2350.UInt9 := 16#0#;
   ...
   subtype M0_RCMD_PREFIX_Field is RP2350.Byte;
   subtype M0_RCMD_SUFFIX_Field is RP2350.Byte;
   ...
   subtype M0_WFMT_DTR_Field is RP2350.Bit;
   ...
   type M0_WFMT_Register is record
      --  The transfer width used for the command prefix, if any
      PREFIX_WIDTH   : M0_WFMT_PREFIX_WIDTH_Field := RP2350.QMI.S;
      --  The transfer width used for the address. The address phase always
      --  transfers 24 bits in total.
      ADDR_WIDTH     : M0_WFMT_ADDR_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the post-address command suffix, if any
      SUFFIX_WIDTH   : M0_WFMT_SUFFIX_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the dummy phase, if any. If width is single,
      --  SD0/MOSI is held asserted low during the dummy phase, and SD1...SD3
      --  are tristated. If width is dual/quad, all IOs are tristated during
      --  the dummy phase.
      DUMMY_WIDTH    : M0_WFMT_DUMMY_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the data transfer
      DATA_WIDTH     : M0_WFMT_DATA_WIDTH_Field := RP2350.QMI.S;
      --  unspecified
      Reserved_10_11 : RP2350.UInt2 := 16#0#;
      --  Length of command prefix, in units of 8 bits. (i.e. 2 cycles for quad
      --  width, 4 for dual, 8 for single)
      PREFIX_LEN     : M0_WFMT_PREFIX_LEN_Field := RP2350.QMI.Val_8;
      --  unspecified
      Reserved_13_13 : RP2350.Bit := 16#0#;
      --  Length of post-address command suffix, in units of 4 bits. (i.e. 1
      --  cycle for quad width, 2 for dual, 4 for single) Only values of 0 and
      --  8 bits are supported.
      SUFFIX_LEN     : M0_WFMT_SUFFIX_LEN_Field := RP2350.QMI.NONE;
      --  Length of dummy phase between command suffix and data phase, in units
      --  of 4 bits. (i.e. 1 cycle for quad width, 2 for dual, 4 for single)
      DUMMY_LEN      : M0_WFMT_DUMMY_LEN_Field := RP2350.QMI.NONE;
      --  unspecified
      Reserved_19_27 : RP2350.UInt9 := 16#0#;
   ...
   subtype M0_WCMD_PREFIX_Field is RP2350.Byte;
   subtype M0_WCMD_SUFFIX_Field is RP2350.Byte;
   ...
   subtype M1_TIMING_CLKDIV_Field is RP2350.Byte;
   subtype M1_TIMING_RXDELAY_Field is RP2350.UInt3;
   subtype M1_TIMING_MIN_DESELECT_Field is RP2350.UInt5;
   subtype M1_TIMING_MAX_SELECT_Field is RP2350.UInt6;
   subtype M1_TIMING_SELECT_HOLD_Field is RP2350.UInt2;
   subtype M1_TIMING_SELECT_SETUP_Field is RP2350.Bit;
   ...
   subtype M1_TIMING_COOLDOWN_Field is RP2350.UInt2;
   ...
   type M1_TIMING_Register is record
      ...
      --  time is one half SCK period, which is usually sufficient except for
      --  very high SCK frequencies with some flash devices.
      SELECT_SETUP   : M1_TIMING_SELECT_SETUP_Field := 16#0#;
      --  unspecified
      Reserved_26_27 : RP2350.UInt2 := 16#0#;
      --  When page break is enabled, chip select will automatically deassert
      --  when crossing certain power-of-2-aligned address boundaries. The next
      ...
      --  boundary. This option allows the QMI to safely support those devices.
      --  This field has no effect when COOLDOWN is disabled.
      PAGEBREAK      : M1_TIMING_PAGEBREAK_Field := RP2350.QMI.NONE;
      --  Chip select cooldown period. When a memory transfer finishes, the
      --  chip select remains asserted for 64 x COOLDOWN system clock cycles,
      --  plus half an SCK clock period (rounded up for odd SCK divisors).
      --  After this cooldown expires, the chip select is always deasserted to
   ...
   subtype M1_RFMT_DTR_Field is RP2350.Bit;
   ...
   type M1_RFMT_Register is record
      --  The transfer width used for the command prefix, if any
      PREFIX_WIDTH   : M1_RFMT_PREFIX_WIDTH_Field := RP2350.QMI.S;
      --  The transfer width used for the address. The address phase always
      --  transfers 24 bits in total.
      ADDR_WIDTH     : M1_RFMT_ADDR_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the post-address command suffix, if any
      SUFFIX_WIDTH   : M1_RFMT_SUFFIX_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the dummy phase, if any. If width is single,
      --  SD0/MOSI is held asserted low during the dummy phase, and SD1...SD3
      --  are tristated. If width is dual/quad, all IOs are tristated during
      --  the dummy phase.
      DUMMY_WIDTH    : M1_RFMT_DUMMY_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the data transfer
      DATA_WIDTH     : M1_RFMT_DATA_WIDTH_Field := RP2350.QMI.S;
      --  unspecified
      Reserved_10_11 : RP2350.UInt2 := 16#0#;
      --  Length of command prefix, in units of 8 bits. (i.e. 2 cycles for quad
      --  width, 4 for dual, 8 for single)
      PREFIX_LEN     : M1_RFMT_PREFIX_LEN_Field := RP2350.QMI.Val_8;
      --  unspecified
      Reserved_13_13 : RP2350.Bit := 16#0#;
      --  Length of post-address command suffix, in units of 4 bits. (i.e. 1
      --  cycle for quad width, 2 for dual, 4 for single) Only values of 0 and
      --  8 bits are supported.
      SUFFIX_LEN     : M1_RFMT_SUFFIX_LEN_Field := RP2350.QMI.NONE;
      --  Length of dummy phase between command suffix and data phase, in units
      --  of 4 bits. (i.e. 1 cycle for quad width, 2 for dual, 4 for single)
      DUMMY_LEN      : M1_RFMT_DUMMY_LEN_Field := RP2350.QMI.NONE;
      --  unspecified
      Reserved_19_27 : RP2350.UInt9 := 16#0#;
      --  Enable double transfer rate (DTR) for read commands: address, suffix
      --  and read data phases are active on both edges of SCK. SDO data is
   ...
   subtype M1_RCMD_PREFIX_Field is RP2350.Byte;
   subtype M1_RCMD_SUFFIX_Field is RP2350.Byte;
   ...
   subtype M1_WFMT_DTR_Field is RP2350.Bit;
   ...
   type M1_WFMT_Register is record
      --  The transfer width used for the command prefix, if any
      PREFIX_WIDTH   : M1_WFMT_PREFIX_WIDTH_Field := RP2350.QMI.S;
      --  The transfer width used for the address. The address phase always
      --  transfers 24 bits in total.
      ADDR_WIDTH     : M1_WFMT_ADDR_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the post-address command suffix, if any
      SUFFIX_WIDTH   : M1_WFMT_SUFFIX_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the dummy phase, if any. If width is single,
      --  SD0/MOSI is held asserted low during the dummy phase, and SD1...SD3
      --  are tristated. If width is dual/quad, all IOs are tristated during
      --  the dummy phase.
      DUMMY_WIDTH    : M1_WFMT_DUMMY_WIDTH_Field := RP2350.QMI.S;
      --  The width used for the data transfer
      DATA_WIDTH     : M1_WFMT_DATA_WIDTH_Field := RP2350.QMI.S;
      --  unspecified
      Reserved_10_11 : RP2350.UInt2 := 16#0#;
      --  Length of command prefix, in units of 8 bits. (i.e. 2 cycles for quad
      --  width, 4 for dual, 8 for single)
      PREFIX_LEN     : M1_WFMT_PREFIX_LEN_Field := RP2350.QMI.Val_8;
      --  unspecified
      Reserved_13_13 : RP2350.Bit := 16#0#;
      --  Length of post-address command suffix, in units of 4 bits. (i.e. 1
      --  cycle for quad width, 2 for dual, 4 for single) Only values of 0 and
      --  8 bits are supported.
      SUFFIX_LEN     : M1_WFMT_SUFFIX_LEN_Field := RP2350.QMI.NONE;
      --  Length of dummy phase between command suffix and data phase, in units
      --  of 4 bits. (i.e. 1 cycle for quad width, 2 for dual, 4 for single)
      DUMMY_LEN      : M1_WFMT_DUMMY_LEN_Field := RP2350.QMI.NONE;
      --  unspecified
      Reserved_19_27 : RP2350.UInt9 := 16#0#;
      --  Enable double transfer rate (DTR) for write commands: address, suffix
      --  and write data phases are active on both edges of SCK. SDO data is
   ...
   subtype M1_WCMD_PREFIX_Field is RP2350.Byte;
   subtype M1_WCMD_SUFFIX_Field is RP2350.Byte;
   ...
   subtype ATRANS_BASE_Field is RP2350.UInt12;
   subtype ATRANS_SIZE_Field is RP2350.UInt11;
