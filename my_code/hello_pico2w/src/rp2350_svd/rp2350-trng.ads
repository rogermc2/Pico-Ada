...
package RP2350.TRNG is
   ...
   subtype RNG_IMR_EHR_VALID_INT_MASK_Field is RP2350.Bit;
   subtype RNG_IMR_AUTOCORR_ERR_INT_MASK_Field is RP2350.Bit;
   subtype RNG_IMR_CRNGT_ERR_INT_MASK_Field is RP2350.Bit;
   subtype RNG_IMR_VN_ERR_INT_MASK_Field is RP2350.Bit;
   subtype RNG_IMR_RESERVED_Field is RP2350.UInt28;
   ...
   type RNG_IMR_Register is record
      ...
      EHR_VALID_INT_MASK    : RNG_IMR_EHR_VALID_INT_MASK_Field := 16#1#;
      --  1'b1-mask interrupt, no interrupt will be generated. See RNG_ISR for
      --  an explanation on this interrupt.
      AUTOCORR_ERR_INT_MASK : RNG_IMR_AUTOCORR_ERR_INT_MASK_Field := 16#1#;
      --  1'b1-mask interrupt, no interrupt will be generated. See RNG_ISR for
      --  an explanation on this interrupt.
      CRNGT_ERR_INT_MASK    : RNG_IMR_CRNGT_ERR_INT_MASK_Field := 16#1#;
      --  1'b1-mask interrupt, no interrupt will be generated. See RNG_ISR for
      --  an explanation on this interrupt.
      VN_ERR_INT_MASK       : RNG_IMR_VN_ERR_INT_MASK_Field := 16#1#;
      --  Read-only. RESERVED
   ...
   subtype RNG_ISR_EHR_VALID_Field is RP2350.Bit;
   subtype RNG_ISR_AUTOCORR_ERR_Field is RP2350.Bit;
   subtype RNG_ISR_CRNGT_ERR_Field is RP2350.Bit;
   subtype RNG_ISR_VN_ERR_Field is RP2350.Bit;
   subtype RNG_ISR_RESERVED_Field is RP2350.UInt28;
   ...
   type RNG_ISR_Register is record
      ...
      EHR_VALID    : RNG_ISR_EHR_VALID_Field;
      ...
      AUTOCORR_ERR : RNG_ISR_AUTOCORR_ERR_Field;
      ...
      CRNGT_ERR    : RNG_ISR_CRNGT_ERR_Field;
   ...
   subtype RNG_ICR_EHR_VALID_Field is RP2350.Bit;
   subtype RNG_ICR_AUTOCORR_ERR_Field is RP2350.Bit;
   subtype RNG_ICR_CRNGT_ERR_Field is RP2350.Bit;
   subtype RNG_ICR_VN_ERR_Field is RP2350.Bit;
   subtype RNG_ICR_RESERVED_Field is RP2350.UInt28;

   --  Interrupt/status bit clear Register.
   type RNG_ICR_Register is record
      --  Write 1'b1 - clear corresponding bit in RNG_ISR.
      EHR_VALID    : RNG_ICR_EHR_VALID_Field := 16#0#;
      --  Cannot be cleared by SW! Only RNG reset clears this bit.
      AUTOCORR_ERR : RNG_ICR_AUTOCORR_ERR_Field := 16#0#;
      --  Write 1'b1 - clear corresponding bit in RNG_ISR.
      CRNGT_ERR    : RNG_ICR_CRNGT_ERR_Field := 16#0#;
      --  Write 1'b1 - clear corresponding bit in RNG_ISR.
      VN_ERR       : RNG_ICR_VN_ERR_Field := 16#0#;
      --  Read-only. RESERVED
   ...
   subtype TRNG_CONFIG_RND_SRC_SEL_Field is RP2350.UInt2;
   subtype TRNG_CONFIG_RESERVED_Field is RP2350.UInt30;
   ...
   subtype TRNG_VALID_EHR_VALID_Field is RP2350.Bit;
   subtype TRNG_VALID_RESERVED_Field is RP2350.UInt31;
   ...
   type TRNG_VALID_Register is record
      ...
      EHR_VALID : TRNG_VALID_EHR_VALID_Field;
      --  Read-only. RESERVED
   ...
   subtype RND_SOURCE_ENABLE_RND_SRC_EN_Field is RP2350.Bit;
   subtype RND_SOURCE_ENABLE_RESERVED_Field is RP2350.UInt31;
   ...
   type RND_SOURCE_ENABLE_Register is record
      ...
      --  disabled
      RND_SRC_EN : RND_SOURCE_ENABLE_RND_SRC_EN_Field := 16#0#;
      --  Read-only. RESERVED
   ...
   subtype AUTOCORR_STATISTIC_AUTOCORR_TRYS_Field is RP2350.UInt14;
   subtype AUTOCORR_STATISTIC_AUTOCORR_FAILS_Field is RP2350.Byte;
   subtype AUTOCORR_STATISTIC_RESERVED_Field is RP2350.UInt10;
   ...
   subtype TRNG_DEBUG_CONTROL_RESERVED_Field is RP2350.Bit;
   subtype TRNG_DEBUG_CONTROL_VNC_BYPASS_Field is RP2350.Bit;
   subtype TRNG_DEBUG_CONTROL_TRNG_CRNGT_BYPASS_Field is RP2350.Bit;
   subtype TRNG_DEBUG_CONTROL_AUTO_CORRELATE_BYPASS_Field is RP2350.Bit;

   --  Debug register.
   type TRNG_DEBUG_CONTROL_Register is record
      --  Read-only. N/A
      RESERVED              : TRNG_DEBUG_CONTROL_RESERVED_Field := 16#0#;
      --  When set, the Von-Neuman balancer is bypassed (including the 32
      --  consecutive bits test).
      VNC_BYPASS            : TRNG_DEBUG_CONTROL_VNC_BYPASS_Field := 16#0#;
      --  When set, the CRNGT test in the RNG is bypassed.
      TRNG_CRNGT_BYPASS     : TRNG_DEBUG_CONTROL_TRNG_CRNGT_BYPASS_Field :=
                               16#0#;
      --  When set, the autocorrelation test in the TRNG module is bypassed.
      AUTO_CORRELATE_BYPASS : TRNG_DEBUG_CONTROL_AUTO_CORRELATE_BYPASS_Field :=
                               16#0#;
      --  unspecified
   ...
   subtype TRNG_SW_RESET_TRNG_SW_RESET_Field is RP2350.Bit;
   subtype TRNG_SW_RESET_RESERVED_Field is RP2350.UInt31;
   ...
   type TRNG_SW_RESET_Register is record
      ...
      TRNG_SW_RESET : TRNG_SW_RESET_TRNG_SW_RESET_Field := 16#0#;
      --  Read-only. RESERVED
   ...
   subtype RNG_DEBUG_EN_INPUT_RNG_DEBUG_EN_Field is RP2350.Bit;
   subtype RNG_DEBUG_EN_INPUT_RESERVED_Field is RP2350.UInt31;
   ...
   type RNG_DEBUG_EN_INPUT_Register is record
      ...
      RNG_DEBUG_EN : RNG_DEBUG_EN_INPUT_RNG_DEBUG_EN_Field := 16#0#;
      --  Read-only. RESERVED
   ...
   subtype TRNG_BUSY_TRNG_BUSY_Field is RP2350.Bit;
   subtype TRNG_BUSY_RESERVED_Field is RP2350.UInt31;

   --  RNG Busy indication.
   type TRNG_BUSY_Register is record
      --  Read-only. Reflects rng_busy status.
      TRNG_BUSY : TRNG_BUSY_TRNG_BUSY_Field;
      --  Read-only. RESERVED
   ...
   subtype RST_BITS_COUNTER_RST_BITS_COUNTER_Field is RP2350.Bit;
   subtype RST_BITS_COUNTER_RESERVED_Field is RP2350.UInt31;
   ...
   type RST_BITS_COUNTER_Register is record
      ...
      RST_BITS_COUNTER : RST_BITS_COUNTER_RST_BITS_COUNTER_Field := 16#0#;
      --  Read-only. RESERVED
   ...
   subtype RNG_VERSION_EHR_WIDTH_192_Field is RP2350.Bit;
   subtype RNG_VERSION_CRNGT_EXISTS_Field is RP2350.Bit;
   subtype RNG_VERSION_AUTOCORR_EXISTS_Field is RP2350.Bit;
   subtype RNG_VERSION_TRNG_TESTS_BYPASS_EN_Field is RP2350.Bit;
   subtype RNG_VERSION_PRNG_EXISTS_Field is RP2350.Bit;
   subtype RNG_VERSION_KAT_EXISTS_Field is RP2350.Bit;
   subtype RNG_VERSION_RESEEDING_EXISTS_Field is RP2350.Bit;
   subtype RNG_VERSION_RNG_USE_5_SBOXES_Field is RP2350.Bit;
   subtype RNG_VERSION_RESERVED_Field is RP2350.UInt24;

   --  Displays the version settings of the TRNG.
   type RNG_VERSION_Register is record
      --  Read-only. * 1'b1 - 192-bit EHR. *1'b0 - 128-bit EHR
      EHR_WIDTH_192        : RNG_VERSION_EHR_WIDTH_192_Field;
      --  Read-only. * 1'b1 - Exists. *1'b0 - Does not exist
      CRNGT_EXISTS         : RNG_VERSION_CRNGT_EXISTS_Field;
      --  Read-only. * 1'b1 - Exists. *1'b0 - Does not exist
      AUTOCORR_EXISTS      : RNG_VERSION_AUTOCORR_EXISTS_Field;
      --  Read-only. * 1'b1 - Exists. *1'b0 - Does not exist
      TRNG_TESTS_BYPASS_EN : RNG_VERSION_TRNG_TESTS_BYPASS_EN_Field;
      --  Read-only. * 1'b1 - Exists. *1'b0 - Does not exist
      PRNG_EXISTS          : RNG_VERSION_PRNG_EXISTS_Field;
      --  Read-only. * 1'b1 - Exists. *1'b0 - Does not exist
      KAT_EXISTS           : RNG_VERSION_KAT_EXISTS_Field;
      --  Read-only. * 1'b1 - Exists. *1'b0 - Does not exist
      RESEEDING_EXISTS     : RNG_VERSION_RESEEDING_EXISTS_Field;
      --  Read-only. * 1'b1 - 5 SBOX AES. *1'b0 - 20 SBOX AES
      RNG_USE_5_SBOXES     : RNG_VERSION_RNG_USE_5_SBOXES_Field;
      --  Read-only. RESERVED
   ...
   subtype RNG_BIST_CNTR_0_ROSC_CNTR_VAL_Field is RP2350.UInt22;
   subtype RNG_BIST_CNTR_0_RESERVED_Field is RP2350.UInt10;
   ...
   subtype RNG_BIST_CNTR_1_ROSC_CNTR_VAL_Field is RP2350.UInt22;
   subtype RNG_BIST_CNTR_1_RESERVED_Field is RP2350.UInt10;
   ...
   subtype RNG_BIST_CNTR_2_ROSC_CNTR_VAL_Field is RP2350.UInt22;
   subtype RNG_BIST_CNTR_2_RESERVED_Field is RP2350.UInt10;
   ...
   type TRNG_Peripheral is record
      ...
      --  RNG collected bits.
      EHR_DATA0          : aliased RP2350.UInt32;
      --  RNG collected bits.
      EHR_DATA1          : aliased RP2350.UInt32;
      --  RNG collected bits.
      EHR_DATA2          : aliased RP2350.UInt32;
      --  RNG collected bits.
      EHR_DATA3          : aliased RP2350.UInt32;
      --  RNG collected bits.
      EHR_DATA4          : aliased RP2350.UInt32;
      --  RNG collected bits.
      EHR_DATA5          : aliased RP2350.UInt32;
      --  Enable signal for the random source.
      RND_SOURCE_ENABLE  : aliased RND_SOURCE_ENABLE_Register;
      --  Counts clocks between sampling of random bit.
      SAMPLE_CNT1        : aliased RP2350.UInt32;
      --  Statistic about Autocorrelation test activations.
