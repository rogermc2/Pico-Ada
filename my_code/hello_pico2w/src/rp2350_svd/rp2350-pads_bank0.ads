...
package RP2350.PADS_BANK0 is
   ...
   subtype GPIO_SLEWFAST_Field is RP2350.Bit;
   subtype GPIO_SCHMITT_Field is RP2350.Bit;
   subtype GPIO_PDE_Field is RP2350.Bit;
   subtype GPIO_PUE_Field is RP2350.Bit;
   ...
   subtype GPIO_IE_Field is RP2350.Bit;
   subtype GPIO_OD_Field is RP2350.Bit;
   subtype GPIO_ISO_Field is RP2350.Bit;
   ...
   type GPIO_Register is record
      ...
      --  Drive strength.
      DRIVE         : GPIO0_DRIVE_Field := RP2350.PADS_BANK0.Val_4mA;
      --  Input enable
      IE            : GPIO_IE_Field := 16#0#;
   ...
   subtype SWCLK_SLEWFAST_Field is RP2350.Bit;
   subtype SWCLK_SCHMITT_Field is RP2350.Bit;
   subtype SWCLK_PDE_Field is RP2350.Bit;
   subtype SWCLK_PUE_Field is RP2350.Bit;
   ...
   subtype SWCLK_IE_Field is RP2350.Bit;
   subtype SWCLK_OD_Field is RP2350.Bit;
   subtype SWCLK_ISO_Field is RP2350.Bit;
   ...
   type SWCLK_Register is record
      ...
      --  Drive strength.
      DRIVE         : SWCLK_DRIVE_Field := RP2350.PADS_BANK0.Val_4mA;
      --  Input enable
      IE            : SWCLK_IE_Field := 16#1#;
      --  Output disable. Has priority over output enable from peripherals
      OD            : SWCLK_OD_Field := 16#0#;
      --  Pad isolation control. Remove this once the pad is configured by
      --  software.
      ISO           : SWCLK_ISO_Field := 16#0#;
      --  unspecified
      Reserved_9_31 : RP2350.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SWD_SLEWFAST_Field is RP2350.Bit;
   subtype SWD_SCHMITT_Field is RP2350.Bit;
   subtype SWD_PDE_Field is RP2350.Bit;
   subtype SWD_PUE_Field is RP2350.Bit;
   ...
   subtype SWD_IE_Field is RP2350.Bit;
   subtype SWD_OD_Field is RP2350.Bit;
   subtype SWD_ISO_Field is RP2350.Bit;
   ...
   type SWD_Register is record
      ...
      --  Drive strength.
      DRIVE         : SWD_DRIVE_Field := RP2350.PADS_BANK0.Val_4mA;
      --  Input enable
