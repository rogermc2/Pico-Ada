...
package RP2350.OTP_DATA is
   ...
   type OTP_DATA_Peripheral is record
      ...
      --  unique.
      CHIPID0                   : aliased RP2350.UInt16;
      --  Bits 31:16 of public device ID (ECC)
      CHIPID1                   : aliased RP2350.UInt16;
      --  Bits 47:32 of public device ID (ECC)
      CHIPID2                   : aliased RP2350.UInt16;
      --  Bits 63:48 of public device ID (ECC)
      CHIPID3                   : aliased RP2350.UInt16;
      ...
      ROSC_CALIB                : aliased RP2350.UInt16;
      ...
      LPOSC_CALIB               : aliased RP2350.UInt16;
      --  The number of main user GPIOs (bank 0). Should read 48 in the QFN80
      --  package, and 30 in the QFN60 package. (ECC)
      ...
      --  XOR all-ones) (ECC)
      INFO_CRC0                 : aliased RP2350.UInt16;
      --  Upper 16 bits of CRC32 of OTP addresses 0x00 through 0x6b (ECC)
      INFO_CRC1                 : aliased RP2350.UInt16;
      ...
      --  4096 * (value + 1)
      FLASH_PARTITION_SLOT_SIZE : aliased RP2350.UInt16;
      ...
      USB_WHITE_LABEL_ADDR      : aliased RP2350.UInt16;
      ...
      --  address window.
      OTPBOOT_SRC               : aliased RP2350.UInt16;
      ...
      OTPBOOT_LEN               : aliased RP2350.UInt16;
