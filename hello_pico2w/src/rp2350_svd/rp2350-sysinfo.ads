...
package RP2350.SYSINFO is
   ...
   subtype CHIP_ID_STOP_BIT_Field is RP2350.Bit;
   subtype CHIP_ID_MANUFACTURER_Field is RP2350.UInt11;
   subtype CHIP_ID_PART_Field is RP2350.UInt16;
   subtype CHIP_ID_REVISION_Field is RP2350.UInt4;

   --  JEDEC JEP-106 compliant chip identifier.
   type CHIP_ID_Register is record
      --  Read-only.
      STOP_BIT     : CHIP_ID_STOP_BIT_Field;
      --  Read-only.
   ...
   subtype PACKAGE_SEL_PACKAGE_SEL_Field is RP2350.Bit;

   type PACKAGE_SEL_Register is record
      --  Read-only.
      PACKAGE_SEL   : PACKAGE_SEL_PACKAGE_SEL_Field;
      --  unspecified
   ...
   subtype PLATFORM_FPGA_Field is RP2350.Bit;
   subtype PLATFORM_ASIC_Field is RP2350.Bit;
   subtype PLATFORM_HDLSIM_Field is RP2350.Bit;
   subtype PLATFORM_BATCHSIM_Field is RP2350.Bit;
   subtype PLATFORM_GATESIM_Field is RP2350.Bit;
   ...
   type PLATFORM_Register is record
      ...
      --  Read-only.
      HDLSIM        : PLATFORM_HDLSIM_Field;
      --  Read-only.
      BATCHSIM      : PLATFORM_BATCHSIM_Field;
      --  Read-only.
      GATESIM       : PLATFORM_GATESIM_Field;
      --  unspecified
   ...
   type SYSINFO_Peripheral is record
      ...
      GITREF_RP2350 : aliased RP2350.UInt32;
   end record
     with Volatile;
