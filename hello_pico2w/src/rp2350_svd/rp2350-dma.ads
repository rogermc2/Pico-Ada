...
package RP2350.DMA is
   ...
   subtype CH0_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH0_TRANS_COUNT_Register is record
      ...
      --  values are reserved.
      MODE  : CH0_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
   ...
   subtype CH0_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH0_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH0_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH0_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH0_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH0_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH0_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      ...
      --  addresses.
      INCR_READ_REV  : CH0_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH0_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      ...
      --  RING_SEL.
      RING_SIZE      : CH0_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      ...
      TREQ_SEL       : CH0_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      ...
      --  unspecified
      Reserved_27_28 : RP2350.UInt2 := 16#0#;
   ...
   subtype CH1_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH1_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH1_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH1_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH1_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH1_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH1_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH1_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH1_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH1_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH1_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH1_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH1_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH1_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH2_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH2_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH2_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH2_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH2_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH2_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH2_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH2_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH2_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH2_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH2_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH2_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH2_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH2_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH3_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH3_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH3_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH3_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH3_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH3_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH3_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH3_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH3_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH3_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH3_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH3_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH3_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH3_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH4_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH4_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH4_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH4_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH4_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH4_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH4_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH4_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH4_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH4_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH4_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH4_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH4_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH4_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH5_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH5_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH5_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH5_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH5_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH5_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH5_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH5_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH5_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH5_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH5_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH5_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH5_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH5_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH6_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH6_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH6_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH6_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH6_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH6_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH6_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH6_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH6_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH6_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH6_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH6_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH6_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH6_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH7_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH7_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH7_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH7_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH7_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH7_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH7_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH7_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH7_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH7_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH7_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH7_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH7_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH7_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH8_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH8_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH8_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH8_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH8_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH8_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH8_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH8_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH8_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH8_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH8_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH8_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH8_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH8_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH9_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH9_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH9_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH9_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH9_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH9_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH9_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH9_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH9_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH9_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH9_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH9_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH9_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH9_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH10_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH10_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH10_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH10_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH10_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH10_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH10_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH10_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH10_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH10_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH10_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH10_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH10_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH10_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH11_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH11_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH11_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH11_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH11_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH11_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH11_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH11_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH11_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH11_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH11_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      ...
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH11_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH11_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH11_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
   ...
   subtype CH12_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH12_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH12_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH12_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH12_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH12_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH12_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH12_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH12_CTRL_TRIG_Register is record
      ...
      --  transfers, and pause the current transfer sequence (i.e. BUSY will
      --  remain high if already high)
      EN             : CH12_CTRL_TRIG_EN_Field := 16#0#;
      --  HIGH_PRIORITY gives a channel preferential treatment in issue
      --  scheduling: in each scheduling round, all high priority channels are
      --  considered first, and then only a single low priority channel, before
      --  returning to the high priority channels. This only affects the order
      ...
      --  changed. If the DMA is not saturated then a low priority channel will
      --  see no loss of throughput.
      HIGH_PRIORITY  : CH12_CTRL_TRIG_HIGH_PRIORITY_Field := 16#0#;
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH12_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      INCR_READ      : CH12_CTRL_TRIG_INCR_READ_Field := 16#0#;
      --  If 1, and INCR_READ is 1, the read address is decremented rather than
      --  incremented with each transfer. If 1, and INCR_READ is 0, this
      --  otherwise-unused combination causes the read address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH12_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      INCR_WRITE     : CH12_CTRL_TRIG_INCR_WRITE_Field := 16#0#;
      --  If 1, and INCR_WRITE is 1, the write address is decremented rather
      --  than incremented with each transfer. If 1, and INCR_WRITE is 0, this
      --  otherwise-unused combination causes the write address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH12_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH12_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      RING_SEL       : CH12_CTRL_TRIG_RING_SEL_Field := 16#0#;
      --  When this channel completes, it will trigger the channel indicated by
      --  CHAIN_TO. Disable by setting CHAIN_TO = _(this channel)_. Note this
      --  field resets to 0, so channels 1 and above will chain to channel 0 by
      --  default. Set this field to avoid this behaviour.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH12_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
      --  transferring a DMA chain of many small control blocks.
      IRQ_QUIET      : CH12_CTRL_TRIG_IRQ_QUIET_Field := 16#0#;
      --  Apply byte-swap transformation to DMA data. For byte data, this has
      --  no effect. For halfword data, the two bytes of each halfword are
      --  swapped. For word data, the four bytes of each word are swapped to
      --  reverse order.
      BSWAP          : CH12_CTRL_TRIG_BSWAP_Field := 16#0#;
      --  If 1, this channel's data transfers are visible to the sniff
      --  hardware, and each transfer will advance the state of the checksum.
      --  This only applies if the sniff hardware is enabled, and has this
      --  channel selected. This allows checksum to be enabled or disabled on a
      --  per-control- block basis.
      SNIFF_EN       : CH12_CTRL_TRIG_SNIFF_EN_Field := 16#0#;
      --  Read-only. This flag goes high when the channel starts a new transfer
      --  sequence, and low when the last transfer of that sequence completes.
      --  Clearing EN while BUSY is high pauses the channel, and BUSY will stay
      --  high while paused. To terminate a sequence early (and clear the BUSY
      --  flag), see CHAN_ABORT.
      BUSY           : CH12_CTRL_TRIG_BUSY_Field := 16#0#;
      --  unspecified
      Reserved_27_28 : RP2350.UInt2 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a write bus error. Write one
      ...
      --  error was encountered (will not be earlier, or more than 5 transfers
      --  later)
      WRITE_ERROR    : CH12_CTRL_TRIG_WRITE_ERROR_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a read bus error. Write one
      --  to clear. READ_ADDR shows the approximate address where the bus error
      --  was encountered (will not be earlier, or more than 3 transfers later)
      READ_ERROR     : CH12_CTRL_TRIG_READ_ERROR_Field := 16#0#;
      --  Read-only. Logical OR of the READ_ERROR and WRITE_ERROR flags. The
      --  channel halts when it encounters any bus error, and always raises its
      --  channel IRQ flag.
      AHB_ERROR      : CH12_CTRL_TRIG_AHB_ERROR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH13_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH13_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH13_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH13_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH13_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH13_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH13_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH13_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH13_CTRL_TRIG_Register is record
      ...
      --  transfers, and pause the current transfer sequence (i.e. BUSY will
      --  remain high if already high)
      EN             : CH13_CTRL_TRIG_EN_Field := 16#0#;
      --  HIGH_PRIORITY gives a channel preferential treatment in issue
      --  scheduling: in each scheduling round, all high priority channels are
      --  considered first, and then only a single low priority channel, before
      --  returning to the high priority channels. This only affects the order
      ...
      --  changed. If the DMA is not saturated then a low priority channel will
      --  see no loss of throughput.
      HIGH_PRIORITY  : CH13_CTRL_TRIG_HIGH_PRIORITY_Field := 16#0#;
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH13_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      INCR_READ      : CH13_CTRL_TRIG_INCR_READ_Field := 16#0#;
      --  If 1, and INCR_READ is 1, the read address is decremented rather than
      --  incremented with each transfer. If 1, and INCR_READ is 0, this
      --  otherwise-unused combination causes the read address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH13_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      INCR_WRITE     : CH13_CTRL_TRIG_INCR_WRITE_Field := 16#0#;
      --  If 1, and INCR_WRITE is 1, the write address is decremented rather
      --  than incremented with each transfer. If 1, and INCR_WRITE is 0, this
      --  otherwise-unused combination causes the write address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH13_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH13_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      RING_SEL       : CH13_CTRL_TRIG_RING_SEL_Field := 16#0#;
      --  When this channel completes, it will trigger the channel indicated by
      --  CHAIN_TO. Disable by setting CHAIN_TO = _(this channel)_. Note this
      --  field resets to 0, so channels 1 and above will chain to channel 0 by
      --  default. Set this field to avoid this behaviour.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH13_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
      --  transferring a DMA chain of many small control blocks.
      IRQ_QUIET      : CH13_CTRL_TRIG_IRQ_QUIET_Field := 16#0#;
      --  Apply byte-swap transformation to DMA data. For byte data, this has
      --  no effect. For halfword data, the two bytes of each halfword are
      --  swapped. For word data, the four bytes of each word are swapped to
      --  reverse order.
      BSWAP          : CH13_CTRL_TRIG_BSWAP_Field := 16#0#;
      --  If 1, this channel's data transfers are visible to the sniff
      --  hardware, and each transfer will advance the state of the checksum.
      --  This only applies if the sniff hardware is enabled, and has this
      --  channel selected. This allows checksum to be enabled or disabled on a
      --  per-control- block basis.
      SNIFF_EN       : CH13_CTRL_TRIG_SNIFF_EN_Field := 16#0#;
      --  Read-only. This flag goes high when the channel starts a new transfer
      --  sequence, and low when the last transfer of that sequence completes.
      --  Clearing EN while BUSY is high pauses the channel, and BUSY will stay
      --  high while paused. To terminate a sequence early (and clear the BUSY
      --  flag), see CHAN_ABORT.
      BUSY           : CH13_CTRL_TRIG_BUSY_Field := 16#0#;
      --  unspecified
      Reserved_27_28 : RP2350.UInt2 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a write bus error. Write one
      ...
      --  error was encountered (will not be earlier, or more than 5 transfers
      --  later)
      WRITE_ERROR    : CH13_CTRL_TRIG_WRITE_ERROR_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a read bus error. Write one
      --  to clear. READ_ADDR shows the approximate address where the bus error
      --  was encountered (will not be earlier, or more than 3 transfers later)
      READ_ERROR     : CH13_CTRL_TRIG_READ_ERROR_Field := 16#0#;
      --  Read-only. Logical OR of the READ_ERROR and WRITE_ERROR flags. The
      --  channel halts when it encounters any bus error, and always raises its
      --  channel IRQ flag.
      AHB_ERROR      : CH13_CTRL_TRIG_AHB_ERROR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH14_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH14_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH14_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH14_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH14_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH14_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH14_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH14_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH14_CTRL_TRIG_Register is record
      ...
      --  transfers, and pause the current transfer sequence (i.e. BUSY will
      --  remain high if already high)
      EN             : CH14_CTRL_TRIG_EN_Field := 16#0#;
      --  HIGH_PRIORITY gives a channel preferential treatment in issue
      --  scheduling: in each scheduling round, all high priority channels are
      --  considered first, and then only a single low priority channel, before
      --  returning to the high priority channels. This only affects the order
      ...
      --  changed. If the DMA is not saturated then a low priority channel will
      --  see no loss of throughput.
      HIGH_PRIORITY  : CH14_CTRL_TRIG_HIGH_PRIORITY_Field := 16#0#;
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH14_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      INCR_READ      : CH14_CTRL_TRIG_INCR_READ_Field := 16#0#;
      --  If 1, and INCR_READ is 1, the read address is decremented rather than
      --  incremented with each transfer. If 1, and INCR_READ is 0, this
      --  otherwise-unused combination causes the read address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH14_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      INCR_WRITE     : CH14_CTRL_TRIG_INCR_WRITE_Field := 16#0#;
      --  If 1, and INCR_WRITE is 1, the write address is decremented rather
      --  than incremented with each transfer. If 1, and INCR_WRITE is 0, this
      --  otherwise-unused combination causes the write address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH14_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH14_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      RING_SEL       : CH14_CTRL_TRIG_RING_SEL_Field := 16#0#;
      --  When this channel completes, it will trigger the channel indicated by
      --  CHAIN_TO. Disable by setting CHAIN_TO = _(this channel)_. Note this
      --  field resets to 0, so channels 1 and above will chain to channel 0 by
      --  default. Set this field to avoid this behaviour.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH14_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
      --  transferring a DMA chain of many small control blocks.
      IRQ_QUIET      : CH14_CTRL_TRIG_IRQ_QUIET_Field := 16#0#;
      --  Apply byte-swap transformation to DMA data. For byte data, this has
      --  no effect. For halfword data, the two bytes of each halfword are
      --  swapped. For word data, the four bytes of each word are swapped to
      --  reverse order.
      BSWAP          : CH14_CTRL_TRIG_BSWAP_Field := 16#0#;
      --  If 1, this channel's data transfers are visible to the sniff
      --  hardware, and each transfer will advance the state of the checksum.
      --  This only applies if the sniff hardware is enabled, and has this
      --  channel selected. This allows checksum to be enabled or disabled on a
      --  per-control- block basis.
      SNIFF_EN       : CH14_CTRL_TRIG_SNIFF_EN_Field := 16#0#;
      --  Read-only. This flag goes high when the channel starts a new transfer
      --  sequence, and low when the last transfer of that sequence completes.
      --  Clearing EN while BUSY is high pauses the channel, and BUSY will stay
      --  high while paused. To terminate a sequence early (and clear the BUSY
      --  flag), see CHAN_ABORT.
      BUSY           : CH14_CTRL_TRIG_BUSY_Field := 16#0#;
      --  unspecified
      Reserved_27_28 : RP2350.UInt2 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a write bus error. Write one
      ...
      --  error was encountered (will not be earlier, or more than 5 transfers
      --  later)
      WRITE_ERROR    : CH14_CTRL_TRIG_WRITE_ERROR_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a read bus error. Write one
      --  to clear. READ_ADDR shows the approximate address where the bus error
      --  was encountered (will not be earlier, or more than 3 transfers later)
      READ_ERROR     : CH14_CTRL_TRIG_READ_ERROR_Field := 16#0#;
      --  Read-only. Logical OR of the READ_ERROR and WRITE_ERROR flags. The
      --  channel halts when it encounters any bus error, and always raises its
      --  channel IRQ flag.
      AHB_ERROR      : CH14_CTRL_TRIG_AHB_ERROR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH15_TRANS_COUNT_COUNT_Field is RP2350.UInt28;
   ...
   type CH15_TRANS_COUNT_Register is record
      ...
      --  channels or raising interrupts, until an ABORT is raised. All other
      --  values are reserved.
      MODE  : CH15_TRANS_COUNT_MODE_Field := RP2350.DMA.NORMAL;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH15_CTRL_TRIG_EN_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_HIGH_PRIORITY_Field is RP2350.Bit;
   ...
   subtype CH15_CTRL_TRIG_INCR_READ_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_INCR_READ_REV_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_INCR_WRITE_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_INCR_WRITE_REV_Field is RP2350.Bit;
   ...
   subtype CH15_CTRL_TRIG_RING_SEL_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_CHAIN_TO_Field is RP2350.UInt4;
   ...
   subtype CH15_CTRL_TRIG_IRQ_QUIET_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_BSWAP_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_SNIFF_EN_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_BUSY_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_WRITE_ERROR_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_READ_ERROR_Field is RP2350.Bit;
   subtype CH15_CTRL_TRIG_AHB_ERROR_Field is RP2350.Bit;
   ...
   type CH15_CTRL_TRIG_Register is record
      ...
      --  transfers, and pause the current transfer sequence (i.e. BUSY will
      --  remain high if already high)
      EN             : CH15_CTRL_TRIG_EN_Field := 16#0#;
      --  HIGH_PRIORITY gives a channel preferential treatment in issue
      --  scheduling: in each scheduling round, all high priority channels are
      --  considered first, and then only a single low priority channel, before
      --  returning to the high priority channels. This only affects the order
      ...
      --  changed. If the DMA is not saturated then a low priority channel will
      --  see no loss of throughput.
      HIGH_PRIORITY  : CH15_CTRL_TRIG_HIGH_PRIORITY_Field := 16#0#;
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH15_CTRL_TRIG_DATA_SIZE_Field := RP2350.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address. Generally this should be
      --  disabled for peripheral-to-memory transfers.
      INCR_READ      : CH15_CTRL_TRIG_INCR_READ_Field := 16#0#;
      --  If 1, and INCR_READ is 1, the read address is decremented rather than
      --  incremented with each transfer. If 1, and INCR_READ is 0, this
      --  otherwise-unused combination causes the read address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_READ_REV  : CH15_CTRL_TRIG_INCR_READ_REV_Field := 16#0#;
      --  If 1, the write address increments with each transfer. If 0, each
      --  write is directed to the same, initial address. Generally this should
      --  be disabled for memory-to-peripheral transfers.
      INCR_WRITE     : CH15_CTRL_TRIG_INCR_WRITE_Field := 16#0#;
      --  If 1, and INCR_WRITE is 1, the write address is decremented rather
      --  than incremented with each transfer. If 1, and INCR_WRITE is 0, this
      --  otherwise-unused combination causes the write address to be
      --  incremented by twice the transfer size, i.e. skipping over alternate
      --  addresses.
      INCR_WRITE_REV : CH15_CTRL_TRIG_INCR_WRITE_REV_Field := 16#0#;
      --  Size of address wrap region. If 0, don't wrap. For values n > 0, only
      --  the lower n bits of the address will change. This wraps the address
      --  on a (1 << n) byte boundary, facilitating access to naturally-aligned
      --  ring buffers. Ring sizes between 2 and 32768 bytes are possible. This
      --  can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH15_CTRL_TRIG_RING_SIZE_Field := RP2350.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses. If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
      RING_SEL       : CH15_CTRL_TRIG_RING_SEL_Field := 16#0#;
      --  When this channel completes, it will trigger the channel indicated by
      --  CHAIN_TO. Disable by setting CHAIN_TO = _(this channel)_. Note this
      --  field resets to 0, so channels 1 and above will chain to channel 0 by
      --  default. Set this field to avoid this behaviour.
      ...
      --  signals are internal (TIMERS) or external (DREQ, a Data Request from
      --  the system). 0x0 to 0x3a -> select DREQ n as TREQ
      TREQ_SEL       : CH15_CTRL_TRIG_TREQ_SEL_Field := RP2350.DMA.PIO0_TX0;
      --  In QUIET mode, the channel does not generate IRQs at the end of every
      --  transfer block. Instead, an IRQ is raised when NULL is written to a
      --  trigger register, indicating the end of a control block chain. This
      --  reduces the number of interrupts to be serviced by the CPU when
      --  transferring a DMA chain of many small control blocks.
      IRQ_QUIET      : CH15_CTRL_TRIG_IRQ_QUIET_Field := 16#0#;
      --  Apply byte-swap transformation to DMA data. For byte data, this has
      --  no effect. For halfword data, the two bytes of each halfword are
      --  swapped. For word data, the four bytes of each word are swapped to
      --  reverse order.
      BSWAP          : CH15_CTRL_TRIG_BSWAP_Field := 16#0#;
      --  If 1, this channel's data transfers are visible to the sniff
      --  hardware, and each transfer will advance the state of the checksum.
      --  This only applies if the sniff hardware is enabled, and has this
      --  channel selected. This allows checksum to be enabled or disabled on a
      --  per-control- block basis.
      SNIFF_EN       : CH15_CTRL_TRIG_SNIFF_EN_Field := 16#0#;
      --  Read-only. This flag goes high when the channel starts a new transfer
      --  sequence, and low when the last transfer of that sequence completes.
      --  Clearing EN while BUSY is high pauses the channel, and BUSY will stay
      --  high while paused. To terminate a sequence early (and clear the BUSY
      --  flag), see CHAN_ABORT.
      BUSY           : CH15_CTRL_TRIG_BUSY_Field := 16#0#;
      --  unspecified
      Reserved_27_28 : RP2350.UInt2 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a write bus error. Write one
      ...
      --  error was encountered (will not be earlier, or more than 5 transfers
      --  later)
      WRITE_ERROR    : CH15_CTRL_TRIG_WRITE_ERROR_Field := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. If 1, the channel received a read bus error. Write one
      --  to clear. READ_ADDR shows the approximate address where the bus error
      --  was encountered (will not be earlier, or more than 3 transfers later)
      READ_ERROR     : CH15_CTRL_TRIG_READ_ERROR_Field := 16#0#;
      --  Read-only. Logical OR of the READ_ERROR and WRITE_ERROR flags. The
      --  channel halts when it encounters any bus error, and always raises its
      --  channel IRQ flag.
      AHB_ERROR      : CH15_CTRL_TRIG_AHB_ERROR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype INTR_INTR_Field is RP2350.UInt16;
   ...
   subtype INTE0_INTE0_Field is RP2350.UInt16;
   ...
   subtype INTF0_INTF0_Field is RP2350.UInt16;
   ...
   subtype INTS0_INTS0_Field is RP2350.UInt16;
   ...
   subtype INTR1_INTR1_Field is RP2350.UInt16;
   ...
   subtype INTE1_INTE1_Field is RP2350.UInt16;
   ...
   subtype INTF1_INTF1_Field is RP2350.UInt16;
   ...
   subtype INTS1_INTS1_Field is RP2350.UInt16;
   ...
   subtype INTR2_INTR2_Field is RP2350.UInt16;
   ...
   subtype INTE2_INTE2_Field is RP2350.UInt16;
   ...
   subtype INTF2_INTF2_Field is RP2350.UInt16;
   ...
   subtype INTS2_INTS2_Field is RP2350.UInt16;
   ...
   subtype INTR3_INTR3_Field is RP2350.UInt16;
   ...
   subtype INTE3_INTE3_Field is RP2350.UInt16;
   ...
   subtype INTF3_INTF3_Field is RP2350.UInt16;
   ...
   subtype INTS3_INTS3_Field is RP2350.UInt16;
   ...
   subtype TIMER_Y_Field is RP2350.UInt16;
   subtype TIMER_X_Field is RP2350.UInt16;
   ...
   subtype MULTI_CHAN_TRIGGER_MULTI_CHAN_TRIGGER_Field is RP2350.UInt16;
   ...
   subtype SNIFF_CTRL_EN_Field is RP2350.Bit;
   subtype SNIFF_CTRL_DMACH_Field is RP2350.UInt4;
   ...
   subtype SNIFF_CTRL_BSWAP_Field is RP2350.Bit;
   subtype SNIFF_CTRL_OUT_REV_Field is RP2350.Bit;
   subtype SNIFF_CTRL_OUT_INV_Field is RP2350.Bit;
   ...
   type SNIFF_CTRL_Register is record
      ...
      CALC           : SNIFF_CTRL_CALC_Field := RP2350.DMA.CRC32;
   ...
   subtype FIFO_LEVELS_TDF_LVL_Field is RP2350.Byte;
   subtype FIFO_LEVELS_WAF_LVL_Field is RP2350.Byte;
   subtype FIFO_LEVELS_RAF_LVL_Field is RP2350.Byte;
   ...
   subtype CHAN_ABORT_CHAN_ABORT_Field is RP2350.UInt16;
   ...
   subtype N_CHANNELS_N_CHANNELS_Field is RP2350.UInt5;
   ...
   subtype SECCFG_CH_P_Field is RP2350.Bit;
   subtype SECCFG_CH_S_Field is RP2350.Bit;
   subtype SECCFG_CH_LOCK_Field is RP2350.Bit;
   ...
   type SECCFG_CH_Register is record
      ...
      LOCK          : SECCFG_CH_LOCK_Field := 16#0#;
      --  unspecified
   ...
   subtype SECCFG_IRQ_P_Field is RP2350.Bit;
   subtype SECCFG_IRQ_S_Field is RP2350.Bit;
   ...
   subtype SECCFG_MISC_SNIFF_P_Field is RP2350.Bit;
   subtype SECCFG_MISC_SNIFF_S_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER0_P_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER0_S_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER1_P_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER1_S_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER2_P_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER2_S_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER3_P_Field is RP2350.Bit;
   subtype SECCFG_MISC_TIMER3_S_Field is RP2350.Bit;
   ...
   type SECCFG_MISC_Register is record
      ...
      SNIFF_P        : SECCFG_MISC_SNIFF_P_Field := 16#1#;
      ...
      SNIFF_S        : SECCFG_MISC_SNIFF_S_Field := 16#1#;
   ...
   subtype MPU_CTRL_P_Field is RP2350.Bit;
   subtype MPU_CTRL_S_Field is RP2350.Bit;
   subtype MPU_CTRL_NS_HIDE_ADDR_Field is RP2350.Bit;
   ...
   type MPU_CTRL_Register is record
      ...
      P             : MPU_CTRL_P_Field := 16#0#;
      --  Determine whether an address not covered by an active MPU region is
      --  Secure (1) or Non-secure (0)
      S             : MPU_CTRL_S_Field := 16#0#;
      ...
      --  processor SAU map.
      NS_HIDE_ADDR  : MPU_CTRL_NS_HIDE_ADDR_Field := 16#0#;
      --  unspecified
   ...
   subtype MPU_BAR_ADDR_Field is RP2350.UInt27;
   ...
   subtype MPU_LAR_EN_Field is RP2350.Bit;
   subtype MPU_LAR_P_Field is RP2350.Bit;
   subtype MPU_LAR_S_Field is RP2350.Bit;
   subtype MPU_LAR_ADDR_Field is RP2350.UInt27;
   ...
   subtype CH0_DBG_CTDREQ_CH0_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   type CH0_DBG_CTDREQ_Register is record
      ...
      --  unspecified
      Reserved_6_31  : RP2350.UInt26 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CH1_DBG_CTDREQ_CH1_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH2_DBG_CTDREQ_CH2_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH3_DBG_CTDREQ_CH3_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH4_DBG_CTDREQ_CH4_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH5_DBG_CTDREQ_CH5_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH6_DBG_CTDREQ_CH6_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH7_DBG_CTDREQ_CH7_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH8_DBG_CTDREQ_CH8_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH9_DBG_CTDREQ_CH9_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH10_DBG_CTDREQ_CH10_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH11_DBG_CTDREQ_CH11_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH12_DBG_CTDREQ_CH12_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH13_DBG_CTDREQ_CH13_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH14_DBG_CTDREQ_CH14_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   subtype CH15_DBG_CTDREQ_CH15_DBG_CTDREQ_Field is RP2350.UInt6;
   ...
   type DMA_Peripheral is record
      ...
      CH0_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 0 Write Address pointer
      CH0_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 0 Transfer Count
      ...
      CH0_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 0 READ_ADDR register
      CH0_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 0 WRITE_ADDR register
      CH0_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      ...
      --  start the channel.
      CH0_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 0 CTRL register
      CH0_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 0 TRANS_COUNT register
      CH0_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 0 READ_ADDR register
      CH0_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 0 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH0_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 0 CTRL register
      CH0_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 0 WRITE_ADDR register
      CH0_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 0 TRANS_COUNT register
      CH0_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 0 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH0_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 1 Read Address pointer
      CH1_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 1 Write Address pointer
      CH1_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 1 Transfer Count
      ...
      CH1_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 1 READ_ADDR register
      CH1_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 1 WRITE_ADDR register
      CH1_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 1 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH1_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 1 CTRL register
      CH1_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 1 TRANS_COUNT register
      CH1_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 1 READ_ADDR register
      CH1_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 1 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH1_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 1 CTRL register
      CH1_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 1 WRITE_ADDR register
      CH1_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 1 TRANS_COUNT register
      CH1_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 1 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH1_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 2 Read Address pointer
      CH2_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 2 Write Address pointer
      CH2_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 2 Transfer Count
      ...
      CH2_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 2 READ_ADDR register
      CH2_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 2 WRITE_ADDR register
      CH2_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 2 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH2_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 2 CTRL register
      CH2_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 2 TRANS_COUNT register
      CH2_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 2 READ_ADDR register
      CH2_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 2 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH2_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 2 CTRL register
      CH2_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 2 WRITE_ADDR register
      CH2_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 2 TRANS_COUNT register
      CH2_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 2 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH2_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 3 Read Address pointer
      CH3_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 3 Write Address pointer
      CH3_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 3 Transfer Count
      ...
      CH3_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 3 READ_ADDR register
      CH3_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 3 WRITE_ADDR register
      CH3_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 3 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH3_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 3 CTRL register
      CH3_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 3 TRANS_COUNT register
      CH3_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 3 READ_ADDR register
      CH3_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 3 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH3_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 3 CTRL register
      CH3_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 3 WRITE_ADDR register
      CH3_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 3 TRANS_COUNT register
      CH3_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 3 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH3_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 4 Read Address pointer
      CH4_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 4 Write Address pointer
      CH4_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 4 Transfer Count
      ...
      CH4_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 4 READ_ADDR register
      CH4_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 4 WRITE_ADDR register
      CH4_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 4 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH4_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 4 CTRL register
      CH4_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 4 TRANS_COUNT register
      CH4_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 4 READ_ADDR register
      CH4_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 4 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH4_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 4 CTRL register
      CH4_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 4 WRITE_ADDR register
      CH4_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 4 TRANS_COUNT register
      CH4_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 4 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH4_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 5 Read Address pointer
      CH5_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 5 Write Address pointer
      CH5_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 5 Transfer Count
      ...
      CH5_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 5 READ_ADDR register
      CH5_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 5 WRITE_ADDR register
      CH5_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 5 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH5_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 5 CTRL register
      CH5_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 5 TRANS_COUNT register
      CH5_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 5 READ_ADDR register
      CH5_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 5 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH5_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 5 CTRL register
      CH5_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 5 WRITE_ADDR register
      CH5_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 5 TRANS_COUNT register
      CH5_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 5 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH5_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 6 Read Address pointer
      CH6_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 6 Write Address pointer
      CH6_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 6 Transfer Count
      ...
      CH6_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 6 READ_ADDR register
      CH6_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 6 WRITE_ADDR register
      CH6_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 6 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH6_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 6 CTRL register
      CH6_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 6 TRANS_COUNT register
      CH6_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 6 READ_ADDR register
      CH6_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 6 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH6_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 6 CTRL register
      CH6_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 6 WRITE_ADDR register
      CH6_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 6 TRANS_COUNT register
      CH6_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 6 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH6_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 7 Read Address pointer
      CH7_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 7 Write Address pointer
      CH7_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 7 Transfer Count
      ...
      CH7_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 7 READ_ADDR register
      CH7_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 7 WRITE_ADDR register
      CH7_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 7 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH7_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 7 CTRL register
      CH7_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 7 TRANS_COUNT register
      CH7_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 7 READ_ADDR register
      CH7_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 7 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH7_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 7 CTRL register
      CH7_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 7 WRITE_ADDR register
      CH7_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 7 TRANS_COUNT register
      CH7_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 7 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH7_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 8 Read Address pointer
      CH8_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 8 Write Address pointer
      CH8_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 8 Transfer Count
      ...
      CH8_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 8 READ_ADDR register
      CH8_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 8 WRITE_ADDR register
      CH8_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 8 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH8_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 8 CTRL register
      CH8_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 8 TRANS_COUNT register
      CH8_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 8 READ_ADDR register
      CH8_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 8 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH8_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 8 CTRL register
      CH8_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 8 WRITE_ADDR register
      CH8_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 8 TRANS_COUNT register
      CH8_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 8 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH8_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 9 Read Address pointer
      CH9_READ_ADDR             : aliased RP2350.UInt32;
      --  DMA Channel 9 Write Address pointer
      CH9_WRITE_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 9 Transfer Count
      ...
      CH9_AL1_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 9 READ_ADDR register
      CH9_AL1_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 9 WRITE_ADDR register
      CH9_AL1_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 9 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH9_AL1_TRANS_COUNT_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 9 CTRL register
      CH9_AL2_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 9 TRANS_COUNT register
      CH9_AL2_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 9 READ_ADDR register
      CH9_AL2_READ_ADDR         : aliased RP2350.UInt32;
      --  Alias for channel 9 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH9_AL2_WRITE_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Alias for channel 9 CTRL register
      CH9_AL3_CTRL              : aliased RP2350.UInt32;
      --  Alias for channel 9 WRITE_ADDR register
      CH9_AL3_WRITE_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 9 TRANS_COUNT register
      CH9_AL3_TRANS_COUNT       : aliased RP2350.UInt32;
      --  Alias for channel 9 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH9_AL3_READ_ADDR_TRIG    : aliased RP2350.UInt32;
      --  DMA Channel 10 Read Address pointer
      CH10_READ_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 10 Write Address pointer
      CH10_WRITE_ADDR           : aliased RP2350.UInt32;
      --  DMA Channel 10 Transfer Count
      ...
      CH10_AL1_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 10 READ_ADDR register
      CH10_AL1_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 10 WRITE_ADDR register
      CH10_AL1_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 10 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH10_AL1_TRANS_COUNT_TRIG : aliased RP2350.UInt32;
      --  Alias for channel 10 CTRL register
      CH10_AL2_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 10 TRANS_COUNT register
      CH10_AL2_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 10 READ_ADDR register
      CH10_AL2_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 10 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH10_AL2_WRITE_ADDR_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 10 CTRL register
      CH10_AL3_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 10 WRITE_ADDR register
      CH10_AL3_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 10 TRANS_COUNT register
      CH10_AL3_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 10 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH10_AL3_READ_ADDR_TRIG   : aliased RP2350.UInt32;
      --  DMA Channel 11 Read Address pointer
      CH11_READ_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 11 Write Address pointer
      CH11_WRITE_ADDR           : aliased RP2350.UInt32;
      --  DMA Channel 11 Transfer Count
      ...
      CH11_AL1_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 11 READ_ADDR register
      CH11_AL1_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 11 WRITE_ADDR register
      CH11_AL1_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 11 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH11_AL1_TRANS_COUNT_TRIG : aliased RP2350.UInt32;
      --  Alias for channel 11 CTRL register
      CH11_AL2_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 11 TRANS_COUNT register
      CH11_AL2_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 11 READ_ADDR register
      CH11_AL2_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 11 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH11_AL2_WRITE_ADDR_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 11 CTRL register
      CH11_AL3_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 11 WRITE_ADDR register
      CH11_AL3_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 11 TRANS_COUNT register
      CH11_AL3_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 11 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH11_AL3_READ_ADDR_TRIG   : aliased RP2350.UInt32;
      --  DMA Channel 12 Read Address pointer
      CH12_READ_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 12 Write Address pointer
      CH12_WRITE_ADDR           : aliased RP2350.UInt32;
      --  DMA Channel 12 Transfer Count
      ...
      CH12_AL1_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 12 READ_ADDR register
      CH12_AL1_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 12 WRITE_ADDR register
      CH12_AL1_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 12 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH12_AL1_TRANS_COUNT_TRIG : aliased RP2350.UInt32;
      --  Alias for channel 12 CTRL register
      CH12_AL2_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 12 TRANS_COUNT register
      CH12_AL2_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 12 READ_ADDR register
      CH12_AL2_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 12 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH12_AL2_WRITE_ADDR_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 12 CTRL register
      CH12_AL3_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 12 WRITE_ADDR register
      CH12_AL3_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 12 TRANS_COUNT register
      CH12_AL3_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 12 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH12_AL3_READ_ADDR_TRIG   : aliased RP2350.UInt32;
      --  DMA Channel 13 Read Address pointer
      CH13_READ_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 13 Write Address pointer
      CH13_WRITE_ADDR           : aliased RP2350.UInt32;
      --  DMA Channel 13 Transfer Count
      ...
      CH13_AL1_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 13 READ_ADDR register
      CH13_AL1_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 13 WRITE_ADDR register
      CH13_AL1_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 13 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH13_AL1_TRANS_COUNT_TRIG : aliased RP2350.UInt32;
      --  Alias for channel 13 CTRL register
      CH13_AL2_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 13 TRANS_COUNT register
      CH13_AL2_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 13 READ_ADDR register
      CH13_AL2_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 13 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH13_AL2_WRITE_ADDR_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 13 CTRL register
      CH13_AL3_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 13 WRITE_ADDR register
      CH13_AL3_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 13 TRANS_COUNT register
      CH13_AL3_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 13 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH13_AL3_READ_ADDR_TRIG   : aliased RP2350.UInt32;
      --  DMA Channel 14 Read Address pointer
      CH14_READ_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 14 Write Address pointer
      CH14_WRITE_ADDR           : aliased RP2350.UInt32;
      --  DMA Channel 14 Transfer Count
      ...
      CH14_AL1_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 14 READ_ADDR register
      CH14_AL1_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 14 WRITE_ADDR register
      CH14_AL1_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 14 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH14_AL1_TRANS_COUNT_TRIG : aliased RP2350.UInt32;
      --  Alias for channel 14 CTRL register
      CH14_AL2_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 14 TRANS_COUNT register
      CH14_AL2_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 14 READ_ADDR register
      CH14_AL2_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 14 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH14_AL2_WRITE_ADDR_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 14 CTRL register
      CH14_AL3_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 14 WRITE_ADDR register
      CH14_AL3_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 14 TRANS_COUNT register
      CH14_AL3_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 14 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH14_AL3_READ_ADDR_TRIG   : aliased RP2350.UInt32;
      --  DMA Channel 15 Read Address pointer
      CH15_READ_ADDR            : aliased RP2350.UInt32;
      --  DMA Channel 15 Write Address pointer
      CH15_WRITE_ADDR           : aliased RP2350.UInt32;
      --  DMA Channel 15 Transfer Count
      ...
      CH15_AL1_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 15 READ_ADDR register
      CH15_AL1_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 15 WRITE_ADDR register
      CH15_AL1_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 15 TRANS_COUNT register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH15_AL1_TRANS_COUNT_TRIG : aliased RP2350.UInt32;
      --  Alias for channel 15 CTRL register
      CH15_AL2_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 15 TRANS_COUNT register
      CH15_AL2_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 15 READ_ADDR register
      CH15_AL2_READ_ADDR        : aliased RP2350.UInt32;
      --  Alias for channel 15 WRITE_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH15_AL2_WRITE_ADDR_TRIG  : aliased RP2350.UInt32;
      --  Alias for channel 15 CTRL register
      CH15_AL3_CTRL             : aliased RP2350.UInt32;
      --  Alias for channel 15 WRITE_ADDR register
      CH15_AL3_WRITE_ADDR       : aliased RP2350.UInt32;
      --  Alias for channel 15 TRANS_COUNT register
      CH15_AL3_TRANS_COUNT      : aliased RP2350.UInt32;
      --  Alias for channel 15 READ_ADDR register This is a trigger register
      --  (0xc). Writing a nonzero value will reload the channel counter and
      --  start the channel.
      CH15_AL3_READ_ADDR_TRIG   : aliased RP2350.UInt32;
      --  Interrupt Status (raw)
      ...
      SNIFF_DATA                : aliased RP2350.UInt32;
      --  Debug RAF, WAF, TDF levels
      ...
      --  next transfer
      CH0_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH1_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH2_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH3_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH4_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH5_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH6_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH7_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH8_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH9_DBG_TCR               : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH10_DBG_TCR              : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH11_DBG_TCR              : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH12_DBG_TCR              : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH13_DBG_TCR              : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH14_DBG_TCR              : aliased RP2350.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH15_DBG_TCR              : aliased RP2350.UInt32;
   end record
     with Volatile;
