...
package RP2350.POWMAN is
   ...
   subtype BADPASSWD_BADPASSWD_Field is RP2350.Bit;

   --  Indicates a bad password has been used
   type BADPASSWD_Register is record
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      BADPASSWD     : BADPASSWD_BADPASSWD_Field := 16#0#;
      --  unspecified
   ...
   subtype VREG_CTRL_HT_TH_Field is RP2350.UInt3;
   subtype VREG_CTRL_DISABLE_VOLTAGE_LIMIT_Field is RP2350.Bit;
   subtype VREG_CTRL_ISOLATE_Field is RP2350.Bit;
   subtype VREG_CTRL_UNLOCK_Field is RP2350.Bit;
   subtype VREG_CTRL_RST_N_Field is RP2350.Bit;
   ...
   subtype VREG_HIZ_Field is RP2350.Bit;
   subtype VREG_VSEL_Field is RP2350.UInt5;
   subtype VREG_UPDATE_IN_PROGRESS_Field is RP2350.Bit;
   ...
   subtype VREG_LP_ENTRY_HIZ_Field is RP2350.Bit;
   subtype VREG_LP_ENTRY_MODE_Field is RP2350.Bit;
   subtype VREG_LP_ENTRY_VSEL_Field is RP2350.UInt5;
   ...
   type VREG_LP_ENTRY_Register is record
      ...
      --  high impedance mode select 0=not in high impedance mode, 1=in high
      --  impedance mode
      HIZ           : VREG_LP_ENTRY_HIZ_Field := 16#0#;
      ...
      MODE          : VREG_LP_ENTRY_MODE_Field := 16#1#;
      --  unspecified
   ...
   subtype VREG_LP_EXIT_HIZ_Field is RP2350.Bit;
   subtype VREG_LP_EXIT_MODE_Field is RP2350.Bit;
   subtype VREG_LP_EXIT_VSEL_Field is RP2350.UInt5;
   ...
   type VREG_LP_EXIT_Register is record
      ...
      --  high impedance mode select 0=not in high impedance mode, 1=in high
      --  impedance mode
      HIZ           : VREG_LP_EXIT_HIZ_Field := 16#0#;
      --  selects either normal (switching) mode or low power (linear) mode low
      --  power mode can only be selected for output voltages up to 1.3V 0 =
      --  normal mode (switching) 1 = low power mode (linear)
      MODE          : VREG_LP_EXIT_MODE_Field := 16#0#;
      --  unspecified
      Reserved_3_3  : RP2350.Bit := 16#0#;
      --  output voltage select the regulator output voltage is limited to 1.3V
      --  unless the voltage limit is disabled using the disable_voltage_limit
   ...
   subtype BOD_CTRL_ISOLATE_Field is RP2350.Bit;

   --  Brown-out Detection Control
   type BOD_CTRL_Register is record
      --  unspecified
      Reserved_0_11  : RP2350.UInt12 := 16#0#;
      --  isolates the brown-out detection control interface 0 - not isolated
      --  (default) 1 - isolated
      ISOLATE        : BOD_CTRL_ISOLATE_Field := 16#0#;
      --  unspecified
   ...
   subtype BOD_EN_Field is RP2350.Bit;
   subtype BOD_VSEL_Field is RP2350.UInt5;
   ...
   subtype BOD_LP_ENTRY_EN_Field is RP2350.Bit;
   subtype BOD_LP_ENTRY_VSEL_Field is RP2350.UInt5;

   --  Brown-out Detection Low Power Entry Settings
   type BOD_LP_ENTRY_Register is record
      --  enable brown-out detection 0=not enabled, 1=enabled
      EN            : BOD_LP_ENTRY_EN_Field := 16#0#;
      --  unspecified
      Reserved_1_3  : RP2350.UInt3 := 16#0#;
      --  threshold select 00000 - 0.473V 00001 - 0.516V 00010 - 0.559V 00011 -
      --  0.602V 00100 - 0.645VS 00101 - 0.688V 00110 - 0.731V 00111 - 0.774V
   ...
   subtype BOD_LP_EXIT_EN_Field is RP2350.Bit;
   subtype BOD_LP_EXIT_VSEL_Field is RP2350.UInt5;

   --  Brown-out Detection Low Power Exit Settings
   type BOD_LP_EXIT_Register is record
      --  enable brown-out detection 0=not enabled, 1=enabled
      EN            : BOD_LP_EXIT_EN_Field := 16#1#;
      --  unspecified
      Reserved_1_3  : RP2350.UInt3 := 16#0#;
      --  threshold select 00000 - 0.473V 00001 - 0.516V 00010 - 0.559V 00011 -
      --  0.602V 00100 - 0.645VS 00101 - 0.688V 00110 - 0.731V 00111 - 0.774V
   ...
   subtype LPOSC_MODE_Field is RP2350.UInt2;
   subtype LPOSC_TRIM_Field is RP2350.UInt6;
   ...
   subtype CHIP_RESET_DOUBLE_TAP_Field is RP2350.Bit;
   subtype CHIP_RESET_RESCUE_FLAG_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_POR_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_BOR_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_RUN_LOW_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_DP_RESET_REQ_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_RESCUE_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_WATCHDOG_RESET_POWMAN_ASYNC_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_WATCHDOG_RESET_POWMAN_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_WATCHDOG_RESET_SWCORE_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_SWCORE_PD_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_GLITCH_DETECT_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_HZD_SYS_RESET_REQ_Field is RP2350.Bit;
   subtype CHIP_RESET_HAD_WATCHDOG_RESET_RSM_Field is RP2350.Bit;

   --  Chip reset control and status
   type CHIP_RESET_Register is record
      --  This flag is set by double-tapping RUN. It tells bootcode to go into
      --  the bootloader.
      DOUBLE_TAP                      : CHIP_RESET_DOUBLE_TAP_Field := 16#0#;
      --  unspecified
      Reserved_1_3                    : RP2350.UInt3 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      ...
      --  does not lock up.
      RESCUE_FLAG                     : CHIP_RESET_RESCUE_FLAG_Field := 16#0#;
      --  unspecified
      Reserved_5_15                   : RP2350.UInt11 := 16#0#;
      ...
      HAD_BOR                         : CHIP_RESET_HAD_BOR_Field := 16#0#;
      ...
      HAD_RUN_LOW                     : CHIP_RESET_HAD_RUN_LOW_Field := 16#0#;
      ...
      --  powman yes swcore yes psm yes then starts the power sequencer
      HAD_DP_RESET_REQ                : CHIP_RESET_HAD_DP_RESET_REQ_Field :=
                                         16#0#;
      --  unspecified
      Reserved_20_20                  : RP2350.Bit := 16#0#;
      ...
      --  sequencer
      HAD_RESCUE                      : CHIP_RESET_HAD_RESCUE_Field := 16#0#;
      ...
      HAD_WATCHDOG_RESET_POWMAN_ASYNC : CHIP_RESET_HAD_WATCHDOG_RESET_POWMAN_ASYNC_Field :=
                                         16#0#;
      --  Read-only. Last reset was a watchdog timeout which was configured to
      ...
      --  the power sequencer
      HAD_WATCHDOG_RESET_POWMAN       : CHIP_RESET_HAD_WATCHDOG_RESET_POWMAN_Field :=
                                         16#0#;
      --  Read-only. Last reset was a watchdog timeout which was configured to
      ...
      --  power sequencer
      HAD_WATCHDOG_RESET_SWCORE       : CHIP_RESET_HAD_WATCHDOG_RESET_SWCORE_Field :=
                                         16#0#;
      ...
      HAD_HZD_SYS_RESET_REQ           : CHIP_RESET_HAD_HZD_SYS_RESET_REQ_Field :=
                                         16#0#;
      --  Read-only. Last reset was a watchdog timeout which was configured to
      ...
      HAD_WATCHDOG_RESET_RSM          : CHIP_RESET_HAD_WATCHDOG_RESET_RSM_Field :=
                                         16#0#;
      --  unspecified
   ...
   subtype WDSEL_RESET_POWMAN_ASYNC_Field is RP2350.Bit;
   subtype WDSEL_RESET_POWMAN_Field is RP2350.Bit;
   subtype WDSEL_RESET_SWCORE_Field is RP2350.Bit;
   subtype WDSEL_RESET_RSM_Field is RP2350.Bit;
   ...
   type WDSEL_Register is record
      ...
      RESET_POWMAN_ASYNC : WDSEL_RESET_POWMAN_ASYNC_Field := 16#0#;
      --  unspecified
      Reserved_1_3       : RP2350.UInt3 := 16#0#;
      --  If set to 1, a watchdog reset will restore powman defaults, reset the
      ...
      RESET_POWMAN       : WDSEL_RESET_POWMAN_Field := 16#0#;
      --  unspecified
      ...
      RESET_SWCORE       : WDSEL_RESET_SWCORE_Field := 16#0#;
      --  unspecified
      Reserved_9_11      : RP2350.UInt3 := 16#0#;
      ...
      RESET_RSM          : WDSEL_RESET_RSM_Field := 16#0#;
      --  unspecified
      Reserved_13_31     : RP2350.UInt19 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SEQ_CFG_HW_PWRUP_SRAM1_Field is RP2350.Bit;
   subtype SEQ_CFG_HW_PWRUP_SRAM0_Field is RP2350.Bit;
   subtype SEQ_CFG_USE_VREG_LP_Field is RP2350.Bit;
   subtype SEQ_CFG_USE_VREG_HP_Field is RP2350.Bit;
   subtype SEQ_CFG_USE_BOD_LP_Field is RP2350.Bit;
   subtype SEQ_CFG_USE_BOD_HP_Field is RP2350.Bit;
   subtype SEQ_CFG_RUN_LPOSC_IN_LP_Field is RP2350.Bit;
   subtype SEQ_CFG_USE_FAST_POWCK_Field is RP2350.Bit;
   subtype SEQ_CFG_USING_VREG_LP_Field is RP2350.Bit;
   subtype SEQ_CFG_USING_BOD_LP_Field is RP2350.Bit;
   subtype SEQ_CFG_USING_FAST_POWCK_Field is RP2350.Bit;
   ...
   type SEQ_CFG_Register is record
      ...
      --  change
      HW_PWRUP_SRAM1   : SEQ_CFG_HW_PWRUP_SRAM1_Field := 16#0#;
      --  Specifies the power state of SRAM0 when powering up swcore from a low
      --  power state (P1.xxx) to a high power state (P0.0xx). 0=power-up 1=no
      --  change
      HW_PWRUP_SRAM0   : SEQ_CFG_HW_PWRUP_SRAM0_Field := 16#0#;
      --  unspecified
      Reserved_2_3     : RP2350.UInt2 := 16#0#;
      ...
      USE_VREG_LP      : SEQ_CFG_USE_VREG_LP_Field := 16#1#;
      ...
      RUN_LPOSC_IN_LP  : SEQ_CFG_RUN_LPOSC_IN_LP_Field := 16#1#;
      --  unspecified
      Reserved_9_11    : RP2350.UInt3 := 16#0#;
      ...
      --  run
      USE_FAST_POWCK   : SEQ_CFG_USE_FAST_POWCK_Field := 16#1#;
      --  unspecified
      ...
      USING_FAST_POWCK : SEQ_CFG_USING_FAST_POWCK_Field := 16#1#;
      --  unspecified
   ...
   subtype STATE_CURRENT_Field is RP2350.UInt4;
   subtype STATE_REQ_Field is RP2350.UInt4;
   subtype STATE_REQ_IGNORED_Field is RP2350.Bit;
   subtype STATE_PWRUP_WHILE_WAITING_Field is RP2350.Bit;
   subtype STATE_BAD_SW_REQ_Field is RP2350.Bit;
   subtype STATE_BAD_HW_REQ_Field is RP2350.Bit;
   subtype STATE_WAITING_Field is RP2350.Bit;
   subtype STATE_CHANGING_Field is RP2350.Bit;
   ...
   type STATE_Register is record
      ...
      --  it
      WAITING             : STATE_WAITING_Field := 16#0#;
      --  Read-only. Indicates a power state change is in progress
      CHANGING            : STATE_CHANGING_Field := 16#0#;
      --  unspecified
      Reserved_14_31      : RP2350.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype POW_FASTDIV_POW_FASTDIV_Field is RP2350.UInt11;
   ...
   subtype POW_DELAY_SWCORE_STEP_Field is RP2350.UInt4;
   subtype POW_DELAY_XIP_STEP_Field is RP2350.UInt4;
   subtype POW_DELAY_SRAM_STEP_Field is RP2350.Byte;
   ...
   subtype EXT_CTRL_GPIO_SELECT_Field is RP2350.UInt6;
   subtype EXT_CTRL_INIT_Field is RP2350.Bit;
   subtype EXT_CTRL_INIT_STATE_Field is RP2350.Bit;
   subtype EXT_CTRL_LP_ENTRY_STATE_Field is RP2350.Bit;
   subtype EXT_CTRL_LP_EXIT_STATE_Field is RP2350.Bit;
   ...
   type EXT_CTRL_Register is record
      ...
      INIT           : EXT_CTRL_INIT_Field := 16#0#;
      --  unspecified
      Reserved_9_11  : RP2350.UInt3 := 16#0#;
      INIT_STATE     : EXT_CTRL_INIT_STATE_Field := 16#0#;
      --  output level when entering the low power state
      LP_ENTRY_STATE : EXT_CTRL_LP_ENTRY_STATE_Field := 16#0#;
      --  output level when exiting the low power state
      LP_EXIT_STATE  : EXT_CTRL_LP_EXIT_STATE_Field := 16#0#;
      --  unspecified
      Reserved_15_31 : RP2350.UInt17 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype EXT_TIME_REF_SOURCE_SEL_Field is RP2350.UInt2;
   subtype EXT_TIME_REF_DRIVE_LPCK_Field is RP2350.Bit;
   ...
   type EXT_TIME_REF_Register is record
      ...
      DRIVE_LPCK    : EXT_TIME_REF_DRIVE_LPCK_Field := 16#0#;
      --  unspecified
   ...
   subtype LPOSC_FREQ_KHZ_INT_LPOSC_FREQ_KHZ_INT_Field is RP2350.UInt6;
   ...
   subtype LPOSC_FREQ_KHZ_FRAC_LPOSC_FREQ_KHZ_FRAC_Field is RP2350.UInt16;
   ...
   subtype XOSC_FREQ_KHZ_INT_XOSC_FREQ_KHZ_INT_Field is RP2350.UInt16;
   ...
   subtype XOSC_FREQ_KHZ_FRAC_XOSC_FREQ_KHZ_FRAC_Field is RP2350.UInt16;
   ...
   subtype SET_TIME_63TO48_SET_TIME_63TO48_Field is RP2350.UInt16;
   ...
   subtype SET_TIME_47TO32_SET_TIME_47TO32_Field is RP2350.UInt16;
   ...
   subtype SET_TIME_31TO16_SET_TIME_31TO16_Field is RP2350.UInt16;
   ...
   subtype SET_TIME_15TO0_SET_TIME_15TO0_Field is RP2350.UInt16;
   ...
   subtype ALARM_TIME_63TO48_ALARM_TIME_63TO48_Field is RP2350.UInt16;
   ...
   subtype ALARM_TIME_47TO32_ALARM_TIME_47TO32_Field is RP2350.UInt16;
   ...
   subtype ALARM_TIME_31TO16_ALARM_TIME_31TO16_Field is RP2350.UInt16;
   ...
   subtype ALARM_TIME_15TO0_ALARM_TIME_15TO0_Field is RP2350.UInt16;
   ...
   subtype TIMER_NONSEC_WRITE_Field is RP2350.Bit;
   subtype TIMER_RUN_Field is RP2350.Bit;
   subtype TIMER_CLEAR_Field is RP2350.Bit;
   subtype TIMER_ALARM_ENAB_Field is RP2350.Bit;
   subtype TIMER_PWRUP_ON_ALARM_Field is RP2350.Bit;
   subtype TIMER_ALARM_Field is RP2350.Bit;
   subtype TIMER_USE_LPOSC_Field is RP2350.Bit;
   subtype TIMER_USE_XOSC_Field is RP2350.Bit;
   subtype TIMER_USE_GPIO_1KHZ_Field is RP2350.Bit;
   subtype TIMER_USE_GPIO_1HZ_Field is RP2350.Bit;
   subtype TIMER_USING_XOSC_Field is RP2350.Bit;
   subtype TIMER_USING_LPOSC_Field is RP2350.Bit;
   subtype TIMER_USING_GPIO_1KHZ_Field is RP2350.Bit;
   subtype TIMER_USING_GPIO_1HZ_Field is RP2350.Bit;
   ...
   type TIMER_Register is record
      ...
      NONSEC_WRITE    : TIMER_NONSEC_WRITE_Field := 16#0#;
      ...
      USE_GPIO_1HZ    : TIMER_USE_GPIO_1HZ_Field := 16#0#;
      --  unspecified
      Reserved_14_15  : RP2350.UInt2 := 16#0#;
      --  Read-only. Timer is running from xosc
      USING_XOSC      : TIMER_USING_XOSC_Field := 16#0#;
      --  Read-only. Timer is running from lposc
      USING_LPOSC     : TIMER_USING_LPOSC_Field := 16#0#;
      --  Read-only. Timer is running from a 1khz gpio source
      USING_GPIO_1KHZ : TIMER_USING_GPIO_1KHZ_Field := 16#0#;
      --  Read-only. Timer is synchronised to a 1hz gpio source
      USING_GPIO_1HZ  : TIMER_USING_GPIO_1HZ_Field := 16#0#;
      --  unspecified
   ...
   subtype PWRUP_SOURCE_Field is RP2350.UInt6;
   subtype PWRUP_ENABLE_Field is RP2350.Bit;
   ...
   subtype PWRUP_STATUS_Field is RP2350.Bit;
   subtype PWRUP_RAW_STATUS_Field is RP2350.Bit;
   ...
   subtype CURRENT_PWRUP_REQ_CURRENT_PWRUP_REQ_Field is RP2350.UInt7;
   ...
   subtype LAST_SWCORE_PWRUP_LAST_SWCORE_PWRUP_Field is RP2350.UInt7;
   ...
   subtype DBG_PWRCFG_IGNORE_Field is RP2350.Bit;
   ...
   type DBG_PWRCFG_Register is record
      ...
      IGNORE        : DBG_PWRCFG_IGNORE_Field := 16#0#;
      --  unspecified
      Reserved_1_31 : RP2350.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype BOOTDIS_NOW_Field is RP2350.Bit;
   subtype BOOTDIS_NEXT_Field is RP2350.Bit;
   ...
   subtype DBGCONFIG_DP_INSTID_Field is RP2350.UInt4;
   ...
   subtype INTR_VREG_OUTPUT_LOW_Field is RP2350.Bit;
   subtype INTR_TIMER_Field is RP2350.Bit;
   subtype INTR_STATE_REQ_IGNORED_Field is RP2350.Bit;
   subtype INTR_PWRUP_WHILE_WAITING_Field is RP2350.Bit;

   --  Raw Interrupts
   type INTR_Register is record
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field.
      VREG_OUTPUT_LOW     : INTR_VREG_OUTPUT_LOW_Field := 16#0#;
      --  Read-only.
      TIMER               : INTR_TIMER_Field := 16#0#;
      --  Read-only. Source is state.req_ignored
      STATE_REQ_IGNORED   : INTR_STATE_REQ_IGNORED_Field := 16#0#;
      --  Read-only. Source is state.pwrup_while_waiting
      PWRUP_WHILE_WAITING : INTR_PWRUP_WHILE_WAITING_Field := 16#0#;
      --  unspecified
      Reserved_4_31       : RP2350.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype INTE_VREG_OUTPUT_LOW_Field is RP2350.Bit;
   subtype INTE_TIMER_Field is RP2350.Bit;
   subtype INTE_STATE_REQ_IGNORED_Field is RP2350.Bit;
   subtype INTE_PWRUP_WHILE_WAITING_Field is RP2350.Bit;

   --  Interrupt Enable
   type INTE_Register is record
      VREG_OUTPUT_LOW     : INTE_VREG_OUTPUT_LOW_Field := 16#0#;
      TIMER               : INTE_TIMER_Field := 16#0#;
      --  Source is state.req_ignored
      STATE_REQ_IGNORED   : INTE_STATE_REQ_IGNORED_Field := 16#0#;
      --  Source is state.pwrup_while_waiting
      PWRUP_WHILE_WAITING : INTE_PWRUP_WHILE_WAITING_Field := 16#0#;
      --  unspecified
      Reserved_4_31       : RP2350.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype INTF_VREG_OUTPUT_LOW_Field is RP2350.Bit;
   subtype INTF_TIMER_Field is RP2350.Bit;
   subtype INTF_STATE_REQ_IGNORED_Field is RP2350.Bit;
   subtype INTF_PWRUP_WHILE_WAITING_Field is RP2350.Bit;

   --  Interrupt Force
   type INTF_Register is record
      VREG_OUTPUT_LOW     : INTF_VREG_OUTPUT_LOW_Field := 16#0#;
      TIMER               : INTF_TIMER_Field := 16#0#;
      --  Source is state.req_ignored
      STATE_REQ_IGNORED   : INTF_STATE_REQ_IGNORED_Field := 16#0#;
      --  Source is state.pwrup_while_waiting
      PWRUP_WHILE_WAITING : INTF_PWRUP_WHILE_WAITING_Field := 16#0#;
      --  unspecified
      Reserved_4_31       : RP2350.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype INTS_VREG_OUTPUT_LOW_Field is RP2350.Bit;
   subtype INTS_TIMER_Field is RP2350.Bit;
   subtype INTS_STATE_REQ_IGNORED_Field is RP2350.Bit;
   subtype INTS_PWRUP_WHILE_WAITING_Field is RP2350.Bit;

   --  Interrupt status after masking & forcing
   type INTS_Register is record
      --  Read-only.
      VREG_OUTPUT_LOW     : INTS_VREG_OUTPUT_LOW_Field;
      --  Read-only.
      TIMER               : INTS_TIMER_Field;
      --  Read-only. Source is state.req_ignored
      STATE_REQ_IGNORED   : INTS_STATE_REQ_IGNORED_Field;
      --  Read-only. Source is state.pwrup_while_waiting
      PWRUP_WHILE_WAITING : INTS_PWRUP_WHILE_WAITING_Field;
      --  unspecified
   ...
   type POWMAN_Peripheral is record
      ...
      READ_TIME_UPPER     : aliased RP2350.UInt32;
      READ_TIME_LOWER     : aliased RP2350.UInt32;
      ...
      SCRATCH0            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH1            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH2            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH3            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH4            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH5            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH6            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      SCRATCH7            : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      BOOT0               : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      BOOT1               : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      BOOT2               : aliased RP2350.UInt32;
      --  Scratch register. Information persists in low power mode
      BOOT3               : aliased RP2350.UInt32;
      --  Raw Interrupts
